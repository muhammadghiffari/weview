...
### How This Connects to WeView

This example is part of the [WeView](https://github.com/ruvnet/WeView) ambient intelligence platform. When combined with WiFi CSI sensing:
