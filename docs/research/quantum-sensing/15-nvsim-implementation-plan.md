...
outside WeView's WiFi-CSI context (magnetic-anomaly modeling, NV-physics teaching,
...
Per layer: formula, units, primary source. When no primary source applies at WeView
...
published guidance for sub-mm dipole at WeView geometry — but deterministic).
...
| NV-NV entanglement, photonic-crystal cavities | Out of WeView hardware budget |
| Diamond growth / NV creation chemistry | Vendor (Element Six) handles |
| Cryogenic operation | WeView ships RT; doc 14 §2.2 |
