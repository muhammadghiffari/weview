...
**Research Document 02** | WeView Project | March 2026
...
This is the core metric used in the WeView coherence gate. For a window of $W$
...
is the variant used in the WeView coherence gate.
...
The WeView tomography module uses ISTA with an $\ell_1$ penalty for voxel-space
...
variance). The WeView longitudinal module uses Welford statistics for
...
The WeView coherence module uses Z-score-based gating to classify link quality:
...
The edge weight computation maps to existing WeView crate structure:
...
*Document prepared for the WeView project. Last updated March 2026.*
