...
## A Comprehensive Survey for WiFi-DensePose / WeView
...
### 9.4 Relation to WeView Codebase

The unified architecture maps directly to existing WeView modules:

| Architecture Layer | WeView Module | File |
|---|---|---|
...
design choices in the WeView/WiFi-DensePose RF topological sensing system.*
