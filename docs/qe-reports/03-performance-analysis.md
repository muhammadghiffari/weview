...
- `/workspaces/weview/v2/crates/wifi-densepose-signal/src/ruvsense/mod.rs`
- `/workspaces/weview/v2/crates/wifi-densepose-signal/src/ruvsense/tomography.rs`
- `/workspaces/weview/v2/crates/wifi-densepose-signal/src/ruvsense/multistatic.rs`
- `/workspaces/weview/v2/crates/wifi-densepose-signal/src/ruvsense/pose_tracker.rs`
- `/workspaces/weview/v2/crates/wifi-densepose-signal/src/ruvsense/field_model.rs`
- `/workspaces/weview/v2/crates/wifi-densepose-signal/src/ruvsense/gesture.rs`
- `/workspaces/weview/v2/crates/wifi-densepose-signal/src/ruvsense/coherence.rs`
- `/workspaces/weview/v2/crates/wifi-densepose-signal/src/ruvsense/coherence_gate.rs`
- `/workspaces/weview/v2/crates/wifi-densepose-signal/src/ruvsense/multiband.rs`
- `/workspaces/weview/v2/crates/wifi-densepose-signal/src/ruvsense/phase_align.rs`
- `/workspaces/weview/v2/crates/wifi-densepose-signal/src/ruvsense/adversarial.rs`
- `/workspaces/weview/v2/crates/wifi-densepose-signal/src/ruvsense/intention.rs`
- `/workspaces/weview/v2/crates/wifi-densepose-signal/src/ruvsense/longitudinal.rs`
- `/workspaces/weview/v2/crates/wifi-densepose-signal/src/ruvsense/cross_room.rs`
- `/workspaces/weview/v2/crates/wifi-densepose-signal/src/ruvsense/temporal_gesture.rs`
- `/workspaces/weview/v2/crates/wifi-densepose-signal/src/ruvsense/attractor_drift.rs`

### Rust Neural Network
- `/workspaces/weview/v2/crates/wifi-densepose-nn/src/inference.rs`
- `/workspaces/weview/v2/crates/wifi-densepose-nn/src/tensor.rs`

### Python Pipeline
- `/workspaces/weview/v1/src/core/csi_processor.py`
- `/workspaces/weview/v1/src/services/pose_service.py`
- `/workspaces/weview/v1/src/api/websocket/connection_manager.py`
- `/workspaces/weview/v1/src/api/websocket/pose_stream.py`
- `/workspaces/weview/v1/src/sensing/feature_extractor.py`

### ESP32 Firmware
- `/workspaces/weview/firmware/esp32-csi-node/main/csi_collector.c`
- `/workspaces/weview/firmware/esp32-csi-node/main/edge_processing.c`
- `/workspaces/weview/firmware/esp32-csi-node/main/edge_processing.h`
