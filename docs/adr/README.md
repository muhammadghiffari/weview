...
This folder contains 44 Architecture Decision Records (ADRs) that document every significant technical choice in the WeView / WiFi-DensePose project.
...
| [ADR-031](ADR-031-weview-sensing-first-rf-mode.md) | WeView Sensing-First RF Mode | Proposed |
