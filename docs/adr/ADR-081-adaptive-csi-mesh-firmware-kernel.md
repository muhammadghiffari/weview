...
WeView's firmware grew bottom-up. ADR-018 defined a binary CSI frame, ADR-029
...
1. **Portability.** Espressif exposes CSI through an official driver API. On
   ...
   firmware build combinations. Future WeView nodes will likely span both
...
Adopt a **5-layer adaptive RF sensing kernel** as the canonical WeView
