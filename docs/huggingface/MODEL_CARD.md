...
The `.rvf` file contains pre-computed embeddings in RuVector format, used by the WeView application for advanced multi-node fusion and cross-viewpoint pose estimation. You only need this if you are using the full WeView pipeline. For basic inference, the ONNX files are sufficient.

---

## How to use with WeView

[WeView](https://github.com/ruvnet/WeView) is the open-source application that ties everything together: firmware flashing, real-time sensing, and a browser-based dashboard.
...
@software{wifi_densepose_2026,
  ...
  author  = {ruvnet},
  year    = {2026},
  url     = {https://github.com/ruvnet/WeView},
  license = {MIT},
...
MIT License. See [LICENSE](https://github.com/ruvnet/WeView/blob/main/LICENSE) for details.
...
- **GitHub:** [github.com/ruvnet/WeView](https://github.com/ruvnet/WeView)
