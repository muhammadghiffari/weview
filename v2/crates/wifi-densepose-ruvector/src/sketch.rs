...
//! a thin WeView-flavored API over `ruvector_core::quantization::BinaryQuantized`.
//!
//! # Why a sketch
//!
//! Every "have I seen something like this before?" comparison in the WeView
...
/// `0xC5110001`). Picked to be distinct from any existing WeView magic.
...
/// non-WeView sender will produce a typed `WireSketchError`, never a
