import{f as Yt,u as Xt,i as w,a as k,b as d,w as H}from"./lit-BS7WqYd5.js";import{y as p,g as Qt,j as f}from"./signals-SG45zFCj.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function a(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=a(i);fetch(i.href,r)}})();/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Jt={attribute:!0,type:String,converter:Xt,reflect:!1,hasChanged:Yt},Zt=(e=Jt,t,a)=>{const{kind:s,metadata:i}=a;let r=globalThis.litPropertyMetadata.get(i);if(r===void 0&&globalThis.litPropertyMetadata.set(i,r=new Map),s==="setter"&&((e=Object.create(e)).wrapped=!0),r.set(a.name,e),s==="accessor"){const{name:n}=a;return{set(o){const l=t.get.call(this);t.set.call(this,o),this.requestUpdate(n,l,e,!0,o)},init(o){return o!==void 0&&this.C(n,void 0,e,o),o}}}if(s==="setter"){const{name:n}=a;return function(o){const l=this[n];t.call(this,o),this.requestUpdate(n,l,e,!0,o)}}throw Error("Unsupported decorator location: "+s)};function ye(e){return(t,a)=>typeof a=="object"?Zt(e,t,a):((s,i,r)=>{const n=i.hasOwnProperty(r);return i.constructor.createProperty(r,s),n?Object.getOwnPropertyDescriptor(i,r):void 0})(e,t,a)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function v(e){return ye({...e,state:!0,attribute:!1})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ea=(e,t,a)=>(a.configurable=!0,a.enumerable=!0,Reflect.decorate&&typeof t!="object"&&Object.defineProperty(e,t,a),a);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Dt(e,t){return(a,s,i)=>{const r=n=>n.renderRoot?.querySelector(e)??null;return ea(a,s,{get(){return r(this)}})}}var ta=Object.defineProperty,aa=Object.getOwnPropertyDescriptor,It=(e,t,a,s)=>{for(var i=s>1?void 0:s?aa(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ta(t,a,i),i};let Ge=class extends k{constructor(){super(...arguments),this.view="scene"}navigate(e){this.dispatchEvent(new CustomEvent("navigate",{detail:e}))}render(){return d`
  ...
  `;It([ye()],Ge.prototype,"view",2);Ge=It([$("nv-rail")],Ge);const P=p("wasm"),R=p(""),Ve=p(!1),nt=p(null),g=p(!1);p(!0);const qe=p(1),sa=p(0),ct=p(0n),Z=p(0xCAFEBABEn),le=p(1e4),de=p(1e3),ce=p(1),pe=p(!0),T=p("dark"),O=p("default"),N=p(!1),Se=p(!0),Re=p([0,0,0]),se=p(0),ee=p(0),M=p(0),F=p(""),C=p("idle"),V=p(""),te=p(null),Pe=p([]),Ke=p([]),Ye=p([]),Ee=p([]),$t=p("rebar-walkby-01"),ia=p(""),Me=p(!1),ot=p("all"),ae=p([]);function ra(e){const t=ae.value.slice();for(t.push(e);t.length>200;)t.shift();ae.value=t}const ue=p([]),Xe=p([]),Qe=p({});function na(e){const t=Xe.value.slice();for(t.push(e);t.length>200;)t.shift();Xe.value=t;const a={...Qe.value};a[e.appId]=(a[e.appId]??0)+1,Qe.value=a}const Ot=p(new Set),St=Qt(()=>P.value==="wasm"?"wasm":"ws"),Ft=p([]),De=p(0),pt=p([]),q=p(0),K=p(!1),Ie=p("wifi"),ut=p([]);let Nt=null;function oa(e){Nt=e}function S(){return Nt}const j=p([]),la=200;function c(e,t){if(Me.value)return;const a=j.value.slice();for(a.push({ts:Date.now(),level:e,msg:t});a.length>la;)a.shift();j.value=a}function da(e){const a=Pe.value.slice();a.push(e[0]),a.length>200&&a.shift();const s=Ke.value.slice();s.push(e[1]),s.length>200&&s.shift();const i=Ye.value.slice();i.push(e[2]),i.length>200&&i.shift(),Pe.value=a,Ke.value=s,Ye.value=i}function ca(e){const a=Ee.value.slice();for(a.push(Math.max(0,Math.min(1,e)));a.length>48;)a.shift();Ee.value=a}var pa=Object.defineProperty,ua=Object.getOwnPropertyDescriptor,Le=(e,t,a,s)=>{for(var i=s>1?void 0:s?ua(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&pa(t,a,i),i};let ie=class extends k{constructor(){super(...arguments),this.open=!1,this.mTitle="",this.mBody="",this.buttons=[],this.onModal=e=>{const t=e.detail;this.mTitle=t.title,this.mBody=t.body,this.buttons=t.buttons??[{label:"Close",variant:"primary"}],this.open=!0,this.setAttribute("open",""),requestAnimationFrame(()=>{const a=this.shadowRoot;if(!a)return;a.querySelector("input, select, textarea, button:not(.close)")?.focus()})},this.onKey=e=>{e.key==="Escape"&&this.open&&this.close()}}connectedCallback(){super.connectedCallback(),window.addEventListener("nv-modal",this.onModal),window.addEventListener("keydown",this.onKey)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("nv-modal",this.onModal),window.removeEventListener("keydown",this.onKey)}updated(){if(!this.open)return;const e=this.shadowRoot;if(!e)return;const t=a=>{if(a.key!=="Tab")return;const s=Array.from(e.querySelectorAll("input, select, textarea, button, [href]")).filter(o=>!o.hasAttribute("disabled"));if(s.length===0)return;const i=s[0],r=s[s.length-1],n=e.activeElement??null;a.shiftKey&&n===i?(a.preventDefault(),r.focus()):!a.shiftKey&&n===r&&(a.preventDefault(),i.focus())};e.removeEventListener("keydown",t),e.addEventListener("keydown",t)}close(){this.open=!1,this.removeAttribute("open")}clickBtn(e){e.onClick?.(),this.close()}render(){return d`
  ...
  `;Le([v()],ie.prototype,"open",2);Le([v()],ie.prototype,"mTitle",2);Le([v()],ie.prototype,"mBody",2);Le([v()],ie.prototype,"buttons",2);ie=Le([$("nv-modal")],ie);function Ae(e){window.dispatchEvent(new CustomEvent("nv-modal",{detail:e}))}var ha=Object.defineProperty,va=Object.getOwnPropertyDescriptor,tt=(e,t,a,s)=>{for(var i=s>1?void 0:s?va(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ha(t,a,i),i};let he=class extends k{constructor(){super(...arguments),this.visible=!1,this.msg="",this.icon="✓",this.timer=null,this.onToast=e=>{const t=e.detail;this.msg=t.msg??"Done",this.icon=t.icon??"✓",this.visible=!0,this.setAttribute("visible",""),this.timer!==null&&window.clearTimeout(this.timer),this.timer=window.setTimeout(()=>{this.visible=!1,this.removeAttribute("visible")},1800)}}connectedCallback(){super.connectedCallback(),window.addEventListener("nv-toast",this.onToast)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("nv-toast",this.onToast)}render(){return d`<span class="icon">${this.icon}</span><span>${this.msg}</span>`}};he.styles=w`
    :host {
  ...
  `;tt([v()],he.prototype,"visible",2);tt([v()],he.prototype,"msg",2);tt([v()],he.prototype,"icon",2);he=tt([$("nv-toast")],he);function U(e,t="✓"){window.dispatchEvent(new CustomEvent("nv-toast",{detail:{msg:e,icon:t}}))}var ma=Object.getOwnPropertyDescriptor,ga=(e,t,a,s)=>{for(var i=s>1?void 0:s?ma(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(i)||i);return i};let ht=class extends k{connectedCallback(){super.connectedCallback(),f(()=>{M.value,St.value,Z.value,T.value,$t.value,g.value,this.requestUpdate()})}async toggleRun(){const e=S();e&&(g.value?(await e.pause(),g.value=!1):(await e.run(),g.value=!0))}async reset(){const e=S();e&&await e.reset()}toggleTheme(){T.value=T.value==="dark"?"light":"dark"}async openSeedModal(){const e=`0x${Z.value.toString(16).toUpperCase().padStart(8,"0")}`;Ae({title:"Set seed",body:`<p>Set the 32-bit hex seed for the shot-noise PRNG. Same <code>(scene, config, seed)</code> → byte-identical witness.</p>
        <label>Hex seed</label>
        <input type="text" id="seed-input" value="${e}" autofocus />`,buttons:[{label:"Cancel",variant:"ghost"},{label:"Apply",variant:"primary",onClick:async()=>{const t=document.querySelector("nv-modal")?.shadowRoot?.querySelector("#seed-input");if(!t)return;const a=t.value.trim().replace(/^0x/i,""),s=BigInt("0x"+a);Z.value=s,await S()?.setSeed(s),c("ok",`seed → 0x${s.toString(16).toUpperCase()}`),U(`Seed → 0x${s.toString(16).toUpperCase().slice(0,8)}`,"⟳")}}]})}openTransportSettings(){window.dispatchEvent(new CustomEvent("open-settings"))}render(){const e=Z.value.toString(16).toUpperCase().padStart(8,"0");return d`
      <div class="crumbs">
        <span class="home">WeView</span><span class="sep">/</span>
        <span>nvsim</span><span class="sep">/</span>
        <span class="cur" id="scene-name">${$t.value}</span>
      </div>
      <div class="spacer"></div>
    ...
    button.ghost { background: transparent; }
  `;ht=ga([$("nv-topbar")],ht);var ba=Object.getOwnPropertyDescriptor,fa=(e,t,a,s)=>{for(var i=s>1?void 0:s?ba(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(i)||i);return i};let lt=null;function Ue(){lt!==null&&window.clearTimeout(lt),lt=window.setTimeout(async()=>{const e=S();if(e)try{await e.setConfig({digitiser:{f_s_hz:le.value,f_mod_hz:de.value},sensor:{gamma_fwhm_hz:1e6,t1_s:.005,t2_s:1e-6,t2_star_s:2e-7,contrast:.03,n_spins:1e12,shot_noise_disabled:!pe.value},dt_s:ce.value*.001}),c("dbg",`config pushed · fs=${le.value} f_mod=${de.value} dt=${ce.value.toFixed(1)}ms noise=${pe.value?"on":"off"}`)}catch(t){c("warn",`config push failed: ${t.message}`)}},300)}let vt=class extends k{connectedCallback(){super.connectedCallback(),f(()=>{le.value,de.value,ce.value,pe.value,g.value,Ie.value,K.value,q.value,De.value,this.requestUpdate()})}render(){const e=K.value,t=Ie.value,a=Math.round(q.value*100);return d`
      <div class="panel">
        <div class="panel-h">Hybrid Fusion <span class="count">${t.toUpperCase()}</span></div>
        <div class="panel-help">
          Auto-selects best pose source. Camera (MediaPipe) used when visible,
          falling back to WiFi CSI (through walls/dark).
        </div>
        <div class="slider-row">
          <div class="top">
            <span class="lbl">Camera Assist</span>
            <span class="val" style="color:var(--accent); cursor:pointer;" @click=${()=>this._toggleCamera()}>
              ${e?"Turn OFF":"Turn ON"}
            </span>
          </div>
        </div>
        ${e?d`
          <div class="field-row">
            <span class="lbl">Camera Confidence</span>
            <span class="val" style="color:${a>70?"var(--ok)":a>30?"var(--warn)":"var(--ink-3)"}">
              ${a}%
            </span>
          </div>
        `:""}
        <div class="field-row">
          <span class="lbl">WiFi Target Count</span>
          <span class="val">${De.value}</span>
        </div>
      </div>
      ...
      <div class="panel">
        ...
        <div class="slider-row" title="Digitiser sample rate — frames per second emitted by the pipeline">
          <div class="top"><span class="lbl">Sample rate</span><span class="val">${(le.value/1e3).toFixed(1)} kHz</span></div>
          <input type="range" min="1000" max="100000" .value=${String(le.value)}
            aria-label="Sample rate in Hz"
            @input=${s=>{le.value=+s.target.value,Ue()}} />
        </div>
        <div class="slider-row" title="Microwave modulation frequency for lock-in demodulation">
          <div class="top"><span class="lbl">Lockin f_mod</span><span class="val">${(de.value/1e3).toFixed(3)} kHz</span></div>
          <input type="range" min="100" max="5000" .value=${String(de.value)}
            aria-label="Lock-in modulation frequency in Hz"
            @input=${s=>{de.value=+s.target.value,Ue()}} />
        </div>
        <div class="slider-row" title="Per-sample integration time">
          <div class="top"><span class="lbl">Integration t</span><span class="val">${ce.value.toFixed(1)} ms</span></div>
          <input type="range" min="0.1" max="10" step="0.1" .value=${String(ce.value)}
            aria-label="Integration time in milliseconds"
            @input=${s=>{ce.value=+s.target.value,Ue()}} />
        </div>
        <div class="slider-row" title="Toggle shot-noise sampling. OFF = analytic noise-free output (debug only)">
          <div class="top"><span class="lbl">Shot noise</span><span class="val">${pe.value?"ON":"OFF"}</span></div>
          <input type="range" min="0" max="1" .value=${pe.value?"1":"0"}
            aria-label="Shot-noise sampling enabled"
            @input=${s=>{pe.value=s.target.value==="1",Ue()}} />
        </div>
      </div>
    ...
    `}_toggleCamera(){window.dispatchEvent(new CustomEvent("nv-toggle-camera"))}};vt.styles=w`
    :host {
  ...
  `;vt=fa([$("nv-sidebar")],vt);var ya=Object.defineProperty,xa=Object.getOwnPropertyDescriptor,xe=(e,t,a,s)=>{for(var i=s>1?void 0:s?xa(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ya(t,a,i),i};let Y=class extends k{constructor(){super(...arguments),this.zoom=1,this.layerVisible={source:!0,field:!0,label:!0},this.items=[{id:"node1",x:220,y:150,color:"oklch(0.65 0.20 150)",name:"ESP32 Node 1 (Tx)"},{id:"node2",x:780,y:150,color:"oklch(0.72 0.18 330)",name:"ESP32 Node 2 (Rx)"},{id:"node3",x:500,y:500,color:"oklch(0.72 0.18 330)",name:"ESP32 Node 3 (Rx)"},{id:"target",x:500,y:250,color:"oklch(0.78 0.14 195)",name:"Human Target"}],this.dragging=null,this.selected=null,this.dragOffset={dx:0,dy:0},this.onKey=e=>{const t=e.target;if(!(t&&(t.tagName==="INPUT"||t.tagName==="TEXTAREA"))){if(!this.selected){e.key==="Tab"&&document.activeElement===document.body&&(e.preventDefault(),this.selected=this.items[0]?.id??null);return}if(e.key==="ArrowLeft"||e.key==="ArrowRight"||e.key==="ArrowUp"||e.key==="ArrowDown"){e.preventDefault();const a=e.shiftKey?32:8,s=e.key==="ArrowLeft"?-a:e.key==="ArrowRight"?a:0,i=e.key==="ArrowUp"?-a:e.key==="ArrowDown"?a:0;this.items=this.items.map(r=>r.id===this.selected?{...r,x:Math.max(20,Math.min(980,r.x+s)),y:Math.max(20,Math.min(580,r.y+i))}:r),ue.value=this.items.map(({id:r,x:n,y:o})=>({id:r,x:n,y:o}))}else if(e.key==="Tab"){e.preventDefault();const s=(this.items.findIndex(i=>i.id===this.selected)+(e.shiftKey?-1:1)+this.items.length)%this.items.length;this.selected=this.items[s].id}else e.key==="Escape"&&(this.selected=null)}},this.onDown=(e,t)=>{t.preventDefault(),this.dragging=e,this.selected=e;const a=this.items.find(r=>r.id===e);if(!a)return;const s=this.renderRoot.querySelector("svg");if(!s)return;const i=this.toSvg(t,s);this.dragOffset={dx:i.x-a.x,dy:i.y-a.y}},this.onPointerMove=e=>{if(!this.dragging)return;const t=this.renderRoot.querySelector("svg");if(!t)return;const a=this.toSvg(e,t);this.items=this.items.map(s=>s.id===this.dragging?{...s,x:a.x-this.dragOffset.dx,y:a.y-this.dragOffset.dy}:s)},this.onPointerUp=()=>{this.dragging&&(ue.value=this.items.map(({id:e,x:t,y:a})=>({id:e,x:t,y:a}))),this.dragging=null}}connectedCallback(){super.connectedCallback(),ue.value.length>0&&(this.items=this.items.map(e=>{const t=ue.value.find(a=>a.id===e.id);return t?{...e,x:t.x,y:t.y}:e})),f(()=>{Re.value,se.value,M.value,ee.value,N.value,g.value,qe.value,te.value,this.requestUpdate()}),f(()=>{const e=te.value;if(!e)return;const t=Math.sqrt(e.bPt[0]**2+e.bPt[1]**2+e.bPt[2]**2),a=Math.max(Math.abs(e.sigmaPt[0]),Math.abs(e.sigmaPt[1]),Math.abs(e.sigmaPt[2]),.001),s=t/a;Number.isFinite(s)&&(ee.value=s)}),window.addEventListener("pointermove",this.onPointerMove),window.addEventListener("pointerup",this.onPointerUp),window.addEventListener("keydown",this.onKey)}async toggleRun(){const e=S();e&&(g.value?(await e.pause(),g.value=!1):(await e.run(),g.value=!0))}async stepFwd(){const e=S();e&&(await e.step("fwd",10),c("dbg","sim step → +1 frame"))}async stepBack(){const e=S();e&&(await e.step("back",10),c("dbg","sim step ← -1 frame"))}cycleSpeed(){const e=[.25,.5,1,2,4],t=e.indexOf(qe.value);qe.value=e[(t+1)%e.length]}zoomIn(){this.zoom=Math.min(2.5,this.zoom*1.2)}zoomOut(){this.zoom=Math.max(.5,this.zoom/1.2)}fitView(){this.zoom=1}toggleLayer(e){this.layerVisible={...this.layerVisible,[e]:!this.layerVisible[e]}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("pointermove",this.onPointerMove),window.removeEventListener("pointerup",this.onPointerUp),window.removeEventListener("keydown",this.onKey)}toSvg(e,t){const a=t.getBoundingClientRect(),s=(e.clientX-a.left)/a.width*1e3,i=(e.clientY-a.top)/a.height*600;return{x:s,y:i}}render(){const e=Re.value,t=[e[0]*1e9,e[1]*1e9,e[2]*1e9],a=se.value*1e9,s=N.value?"":"anim",i=1e3/this.zoom,r=600/this.zoom,n=(1e3-i)/2,o=(600-r)/2;return d`
      <div class="grid"></div>
      <svg viewBox="${n.toFixed(1)} ${o.toFixed(1)} ${i.toFixed(1)} ${r.toFixed(1)}"
        ...
        ${this.layerVisible.field?this.items.map(l=>H`
          <line class="field-line ${s}" x1=${l.x} y1=${l.y}
            x2="500" y2="320"
            stroke=${l.color} stroke-width="1" stroke-opacity="0.5"/>
        `):""}

        <!-- Source primitives / Nodes -->
        ${this.layerVisible.source?this.items.map(l=>H`
          <g class=${`draggable ${this.dragging===l.id?"dragging":""} ${this.selected===l.id?"selected":""}`}
             ...
             @pointerdown=${u=>this.onDown(l.id,u)}>
             
            <!-- Detection Range Indicator (Jangkauan) -->
            ${l.id.includes("node")?H`<circle cx="0" cy="0" r="180" fill=${l.color} fill-opacity="0.04" stroke=${l.color} stroke-width="1" stroke-dasharray="8 8" />`:""}
            ...
            ${this.layerVisible.label?H`<text class="label" x="0" y="40" text-anchor="middle">${l.name}</text>`:""}
          </g>
        `):""}
      ...
      <div class="sim-controls" id="sim-controls">
        ...
        <span class="speed" id="speed-val" title="Cycle speed" @click=${this.cycleSpeed}>${qe.value}×</span>
      </div>
      ...
      <div class="scene-readout">
        ...
        <div class="stat-card">
          ...
          <div class="val mint" id="snr-readout">${ee.value>0?ee.value.toFixed(1):"—"}</div>
        </div>
      </div>
    `}};Y.styles=w`
    :host {
  ...
  `;xe([v()],Y.prototype,"zoom",2);xe([v()],Y.prototype,"layerVisible",2);xe([v()],Y.prototype,"items",2);xe([v()],Y.prototype,"dragging",2);xe([v()],Y.prototype,"selected",2);Y=xe([$("nv-scene")],Y);var wa=Object.defineProperty,ka=Object.getOwnPropertyDescriptor,at=(e,t,a,s)=>{for(var i=s>1?void 0:s?ka(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&wa(t,a,i),i};let ve=class extends k{constructor(){super(...arguments),this.tab="signal",this.pinTab=null,this.expanded=!1}connectedCallback(){super.connectedCallback(),f(()=>{Pe.value,Ke.value,Ye.value,Ee.value,te.value,F.value,C.value,Re.value,se.value,this.requestUpdate()})}willUpdate(e){e.has("pinTab")&&this.pinTab&&this.tab!==this.pinTab&&(this.tab=this.pinTab)}async verify(){const e=S();if(e){C.value="pending",c("info","verifying witness over 256 frames…");try{const t=V.value,a=new Uint8Array(32);for(let i=0;i<32;i++)a[i]=parseInt(t.slice(i*2,i*2+2),16);const s=await e.verifyWitness(a);if(s.ok)C.value="ok",F.value=t,c("ok",`witness ${t.slice(0,16)}… matches · determinism gate ✓`);else{C.value="fail";const i=Array.from(s.actual).map(r=>r.toString(16).padStart(2,"0")).join("");F.value=i,c("err",`WITNESS MISMATCH actual=${i.slice(0,16)}…`)}}catch(t){C.value="fail",c("err",`verify failed: ${t.message}`)}}}renderHeader(){return this.expanded?d`
    ...
    `:""}renderSignalTab(){const r=u=>{let h="";return u.forEach((b,y)=>{const A=y/Math.max(1,199)*320,D=65-b*22;h+=(y===0?"M":"L")+` ${A.toFixed(1)} ${D.toFixed(1)} `}),h},n=Re.value,o=[n[0]*1e9,n[1]*1e9,n[2]*1e9],l=Pe.value.length>0;return d`
      ${l?"":d`
      ...
      <div class=${this.expanded?"grid-2":""}>
        <div class="card">
          ...
          <svg viewBox="0 0 ${320} ${130}" preserveAspectRatio="none">
            ...
            ${H`<path id="trace-x" d=${r(Pe.value)} stroke="oklch(0.78 0.14 70)" stroke-width="1.2" fill="none"/>`}
            ${H`<path id="trace-y" d=${r(Ke.value)} stroke="oklch(0.78 0.12 195)" stroke-width="1.2" fill="none" opacity="0.8"/>`}
            ${H`<path id="trace-z" d=${r(Ye.value)} stroke="oklch(0.72 0.18 330)" stroke-width="1.2" fill="none" opacity="0.7"/>`}
          </svg>
          ${this.expanded?d`<div style="display:flex;gap:14px;font-size:12px;font-family:var(--mono);margin-top:8px;">
            ...
            <span style="color:var(--accent);margin-left:auto;">|B| ${(se.value*1e9).toFixed(3)} nT</span>
          </div>`:""}
        </div>
        ...
        <div class="card">
          ...
          <div class="frame-strip" id="frame-strip">
            ${Ee.value.map(u=>d`<div class="bar" style=${`height:${Math.max(4,u*100)}%`}></div>`)}
          </div>
          ${this.expanded?d`
            <div style="display:flex;gap:24px;font-family:var(--mono);font-size:12px;color:var(--ink-3);margin-top:12px;">
              <span>frames in window: <span style="color:var(--ink);">${Ee.value.length}</span></span>
              <span>noise floor: <span style="color:var(--ink);">${te.value?te.value.noiseFloorPtSqrtHz.toFixed(2)+" pT/√Hz":"—"}</span></span>
            </div>`:""}
        </div>
      </div>
    `}renderFrameTab(){const e=te.value,t=e?.raw;let a="";return t&&(a=Array.from(t).map(i=>i.toString(16).padStart(2,"0")).slice(0,60).join(" ")),d`
      ${e?"":d`
        <div class="card" style="text-align:center; padding:18px;">
          <div style="font-size:13px; color:var(--ink-2); line-height:1.55;">
    ...
    `}renderWitnessTab(){const e=C.value,t=e==="ok"?"ok":e==="fail"?"fail":"",a=e==="pending"?"Verifying…":e==="ok"?"✓ Witness verified · determinism gate":e==="fail"?"✗ Witness mismatch · audit required":"Verify witness",s=V.value&&F.value&&V.value===F.value;return d`
      ${this.expanded?d`
  ...
  `;at([v()],ve.prototype,"tab",2);at([ye({attribute:!1})],ve.prototype,"pinTab",2);at([ye({type:Boolean,reflect:!0})],ve.prototype,"expanded",2);ve=at([$("nv-inspector")],ve);var $a=Object.defineProperty,Sa=Object.getOwnPropertyDescriptor,Ht=(e,t,a,s)=>{for(var i=s>1?void 0:s?Sa(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&$a(t,a,i),i};let Je=class extends k{constructor(){super(...arguments),this.hIdx=-1,this.onKey=e=>{if(e.key==="Enter")this.exec(this.inputEl.value),this.inputEl.value="";else if(e.key==="ArrowUp"){const t=ae.value;t.length&&(this.hIdx=Math.max(0,this.hIdx-1),this.inputEl.value=t[this.hIdx]??"",e.preventDefault())}else if(e.key==="ArrowDown"){const t=ae.value;t.length&&(this.hIdx=Math.min(t.length,this.hIdx+1),this.inputEl.value=t[this.hIdx]??"",e.preventDefault())}}}connectedCallback(){super.connectedCallback(),f(()=>{j.value,ot.value,Me.value,this.requestUpdate()})}updated(){const e=this.renderRoot.querySelector(".body");e&&(e.scrollTop=e.scrollHeight)}counts(){const e={info:0,warn:0,err:0,dbg:0,ok:0};for(const t of j.value)e[t.level]=(e[t.level]??0)+1;return e.all=j.value.length,e}async exec(e){if(e=e.trim(),!e)return;c("info",`<span style="color:var(--accent);">nvsim&gt;</span> ${e}`),ra(e),this.hIdx=ae.value.length;const[t,...a]=e.split(/\s+/),s=a.join(" "),i=S();switch(t){case"help":c("info","commands: help · scene.list · sensor.config · run · pause · reset · seed · proof.verify · proof.export · clear · theme · status");break;case"scene.list":c("info","scene rebar-walkby-01:"),c("info","  rebar.steel.coil   @ [+2.7, 0.0, +0.3] m χ=5000"),c("info","  dipole.heart_proxy @ [-1.4, +0.2, +0.4] m m=1.0e-6 A·m²"),c("info","  loop.mains_60Hz    @ [-1.6, -0.4, 0.0] m I=2 A"),c("info","  eddy.door_steel    @ [+0.0, +1.8, +0.4] m σ=1e6 S/m");break;case"sensor.config":c("info","NvSensor::cots_defaults() {"),c("info","  pos=[0,0,0], V=1mm³, N=1e12, C=0.03, T2*=200ns"),c("info","  D=2.870 GHz, γe=28 GHz/T, Γ=1.0 MHz, axes=4×〈111〉"),c("info","  δB ≈ 1.18 pT/√Hz (Barry 2020 §III.A) }");break;case"run":i&&(await i.run(),g.value=!0,c("ok","pipeline RUN"));break;case"pause":i&&(await i.pause(),g.value=!1,c("warn","pipeline PAUSED"));break;case"reset":i&&(await i.reset(),c("info","pipeline reset · t=0"));break;case"seed":{if(!s){c("info",`current seed = 0x${Z.value.toString(16).toUpperCase()}`);break}const r=BigInt(s.startsWith("0x")?s:"0x"+s);Z.value=r,i&&await i.setSeed(r),c("ok",`seed → 0x${r.toString(16).toUpperCase()}`);break}case"proof.verify":{if(!i)break;c("dbg","computing SHA-256 over 256 frames…");try{const r=V.value,n=new Uint8Array(32);for(let l=0;l<32;l++)n[l]=parseInt(r.slice(l*2,l*2+2),16);(await i.verifyWitness(n)).ok?(C.value="ok",F.value=r,c("ok",`witness ${r.slice(0,16)}… matches · determinism gate ✓`)):(C.value="fail",c("err","WITNESS MISMATCH"))}catch(r){c("err",`verify failed: ${r.message}`)}break}case"proof.export":{if(!i)break;c("dbg","building proof bundle…");try{const r=await i.exportProofBundle(),n=URL.createObjectURL(r),o=document.createElement("a");o.href=n,o.download=`nvsim-proof-${Date.now()}.json`,o.click(),URL.revokeObjectURL(n),c("ok",`proof bundle exported · ${r.size} bytes`)}catch(r){c("err",`export failed: ${r.message}`)}break}case"clear":j.value=[];break;case"theme":{const r=(s||"").toLowerCase();r==="light"||r==="dark"?(T.value=r,c("ok",`theme → ${r}`)):c("info","theme [light|dark]");break}case"status":c("info",`running=${g.value} seed=0x${Z.value.toString(16).toUpperCase()} verified=${C.value}`);break;default:c("err",`unknown command: ${t} · try help`)}}render(){const e=this.counts(),t=ot.value,a=j.value.filter(s=>t==="all"||s.level===t);return d`
      <div class="tabs">
        ...
        <div class="tools">
          <button id="clear-log" title="Clear" @click=${()=>j.value=[]}>×</button>
          <button id="pause-log" title="Pause" @click=${()=>Me.value=!Me.value}>
            ${Me.value?"▶":"❚❚"}
          </button>
        </div>
      </div>
  ...
  `;Ht([Dt("#console-input")],Je.prototype,"inputEl",2);Je=Ht([$("nv-console")],Je);const ze=[{id:"nvsim",name:"nvsim — NV-diamond magnetometer",category:"sim",crate:"nvsim",summary:"Deterministic forward simulator: scene → Biot–Savart → NV ensemble → ADC → MagFrame stream + SHA-256 witness.",budget:"L",active:!0,status:"available",tags:["quantum","magnetometer","simulator","witness","wasm"],adr:"ADR-089",runtime:"running"},{id:"gesture",name:"Gesture (DTW)",category:"sig",crate:"wifi-densepose-wasm-edge",summary:"Dynamic-Time-Warping gesture classifier from CSI motion templates.",events:[1],budget:"M",status:"available",tags:["hci","csi","classifier","dtw"],adr:"ADR-014",runtime:"mesh-only"},{id:"coherence",name:"Coherence gate",category:"sig",crate:"wifi-densepose-wasm-edge",summary:"Z-score coherence scoring + Accept/PredictOnly/Reject/Recalibrate gate.",events:[2],budget:"S",status:"available",tags:["gate","csi","coherence","drift"],adr:"ADR-029",runtime:"simulated"},{id:"adversarial",name:"Adversarial-signal detector",category:"ais",crate:"wifi-densepose-wasm-edge",summary:"Physically-impossible-signal detector — multi-link consistency, used to flag spoofed CSI.",events:[3],budget:"M",status:"available",tags:["security","csi","spoofing","mesh"],adr:"ADR-032",runtime:"simulated"},{id:"rvf",name:"RVF — Rust Verified Feature stream",category:"sig",crate:"wifi-densepose-wasm-edge",summary:"Verified-frame builder with SHA-256 hash + version metadata for the feature stream.",budget:"S",status:"available",tags:["witness","csi","hash"],adr:"ADR-040"},{id:"occupancy",name:"Occupancy estimator",category:"bld",crate:"wifi-densepose-wasm-edge",summary:"Through-wall presence + person-count via CSI amplitude perturbation.",events:[300,301,302],budget:"S",status:"available",tags:["csi","building","presence"],runtime:"simulated"},{id:"vital_trend",name:"Vital-trend monitor",category:"med",crate:"wifi-densepose-wasm-edge",summary:"HR + BR trend tracking with bradycardia/tachycardia/apnea events.",events:[100,101,102,103,104,105],budget:"S",status:"available",tags:["medical","vitals","csi"],adr:"ADR-021",runtime:"simulated"},{id:"intrusion",name:"Intrusion detector",category:"sec",crate:"wifi-densepose-wasm-edge",summary:"Zone-based intrusion alert from CSI motion patterns.",events:[200,201],budget:"S",status:"available",tags:["security","zone","csi"],runtime:"simulated"},{id:"med_sleep_apnea",name:"Sleep-apnea detector",category:"med",crate:"wifi-densepose-wasm-edge",summary:"Episodic respiratory pause detection during sleep cycles.",events:[105],budget:"S",status:"available",tags:["medical","sleep","breathing"]},{id:"med_cardiac_arrhythmia",name:"Cardiac arrhythmia",category:"med",crate:"wifi-densepose-wasm-edge",summary:"Beat-to-beat irregularity classifier from cardiac micro-Doppler.",events:[103,104],budget:"M",status:"available",tags:["medical","cardiac","arrhythmia"]},{id:"med_respiratory_distress",name:"Respiratory distress",category:"med",crate:"wifi-densepose-wasm-edge",summary:"Distress signature: rapid shallow breathing + accessory-muscle motion.",events:[101,102],budget:"S",status:"available",tags:["medical","breathing","icu"]},{id:"med_gait_analysis",name:"Gait analysis",category:"med",crate:"wifi-densepose-wasm-edge",summary:"Stride length, cadence, asymmetry from through-wall CSI pose tracking.",budget:"M",status:"available",tags:["medical","gait","pose"]},{id:"med_seizure_detect",name:"Seizure detector",category:"med",crate:"wifi-densepose-wasm-edge",summary:"Tonic-clonic seizure motion signature.",budget:"M",status:"beta",tags:["medical","neuro"]},{id:"sec_perimeter_breach",name:"Perimeter breach",category:"sec",crate:"wifi-densepose-wasm-edge",summary:"Approach/departure detection at user-defined boundary segments.",events:[210,211,212,213],budget:"S",status:"available",tags:["security","perimeter"]},{id:"sec_weapon_detect",name:"Metal anomaly / weapon",category:"sec",crate:"wifi-densepose-wasm-edge",summary:"Metal-perturbation flag in CSI; potential weapon presence (research).",events:[220,221,222],budget:"M",status:"research",tags:["security","metal","csi"]},{id:"sec_tailgating",name:"Tailgating detector",category:"sec",crate:"wifi-densepose-wasm-edge",summary:"Detect 2+ persons crossing a single-passage threshold.",events:[230,231,232],budget:"S",status:"available",tags:["security","access-control"]},{id:"sec_loitering",name:"Loitering detector",category:"sec",crate:"wifi-densepose-wasm-edge",summary:"Stationary occupancy past a configurable dwell threshold.",events:[240,241,242],budget:"S",status:"available",tags:["security","dwell"]},{id:"sec_panic_motion",name:"Panic motion",category:"sec",crate:"wifi-densepose-wasm-edge",summary:"High-energy distress motion: struggle / fleeing pattern.",events:[250,251,252],budget:"S",status:"beta",tags:["security","distress"]},{id:"bld_hvac_presence",name:"HVAC presence",category:"bld",crate:"wifi-densepose-wasm-edge",summary:"Occupied/activity-level/departure-countdown for HVAC zones.",events:[310,311,312],budget:"S",status:"available",tags:["hvac","building","energy"]},{id:"bld_lighting_zones",name:"Lighting zones",category:"bld",crate:"wifi-densepose-wasm-edge",summary:"Per-zone light on/dim/off cues from occupancy.",events:[320,321,322],budget:"S",status:"available",tags:["lighting","building"]},{id:"bld_elevator_count",name:"Elevator count",category:"bld",crate:"wifi-densepose-wasm-edge",summary:"Person count inside elevator car from CSI.",events:[330],budget:"S",status:"available",tags:["elevator","building"]},{id:"bld_meeting_room",name:"Meeting-room utilization",category:"bld",crate:"wifi-densepose-wasm-edge",summary:"Meeting size + duration analytics for booking systems.",budget:"S",status:"available",tags:["meeting","analytics"]},{id:"bld_energy_audit",name:"Energy audit",category:"bld",crate:"wifi-densepose-wasm-edge",summary:"Continuous occupancy-vs-HVAC-state audit for energy savings.",budget:"M",status:"available",tags:["energy","audit"]},{id:"ret_queue_length",name:"Queue length",category:"ret",crate:"wifi-densepose-wasm-edge",summary:"Live queue-length tracking for checkout / kiosks.",budget:"S",status:"available",tags:["retail","queue"]},{id:"ret_dwell_heatmap",name:"Dwell heatmap",category:"ret",crate:"wifi-densepose-wasm-edge",summary:"Per-zone dwell time accumulation; analytics-only export.",budget:"M",status:"available",tags:["retail","heatmap"]},{id:"ret_customer_flow",name:"Customer flow",category:"ret",crate:"wifi-densepose-wasm-edge",summary:"Origin-destination flow graph through a store layout.",budget:"M",status:"available",tags:["retail","flow"]},{id:"ret_table_turnover",name:"Table turnover",category:"ret",crate:"wifi-densepose-wasm-edge",summary:"Restaurant table seat / vacate transitions.",budget:"S",status:"available",tags:["retail","restaurant"]},{id:"ret_shelf_engagement",name:"Shelf engagement",category:"ret",crate:"wifi-densepose-wasm-edge",summary:"Reach-to-shelf gestures and dwell at product zones.",budget:"M",status:"available",tags:["retail","shelf"]},{id:"ind_forklift_proximity",name:"Forklift proximity",category:"ind",crate:"wifi-densepose-wasm-edge",summary:"Worker-near-forklift safety alert.",budget:"S",status:"available",tags:["industrial","safety"]},{id:"ind_confined_space",name:"Confined-space monitor",category:"ind",crate:"wifi-densepose-wasm-edge",summary:"Last-person-out detection + presence audit for OSHA confined-space entries.",budget:"S",status:"available",tags:["industrial","osha"]},{id:"ind_clean_room",name:"Clean-room PPE / motion",category:"ind",crate:"wifi-densepose-wasm-edge",summary:"Motion patterns consistent with proper PPE-clad movement.",budget:"M",status:"beta",tags:["industrial","cleanroom"]},{id:"ind_livestock_monitor",name:"Livestock monitor",category:"ind",crate:"wifi-densepose-wasm-edge",summary:"Vital-sign + activity tracking for stall-bound livestock.",budget:"M",status:"beta",tags:["agriculture","livestock"]},{id:"ind_structural_vibration",name:"Structural vibration",category:"ind",crate:"wifi-densepose-wasm-edge",summary:"Building/equipment micro-vibration via CSI phase derivative.",budget:"M",status:"research",tags:["industrial","vibration"]},{id:"sig_coherence_gate",name:"Coherence gate (extended)",category:"sig",crate:"wifi-densepose-wasm-edge",summary:"Hysteresis + multi-state coherence gate driving downstream apps.",budget:"S",status:"available",tags:["gate","csi"]},{id:"sig_flash_attention",name:"Flash attention (CSI)",category:"sig",crate:"wifi-densepose-wasm-edge",summary:"Edge-friendly attention block for CSI subcarrier weighting.",budget:"M",status:"beta",tags:["attention","csi"]},{id:"sig_temporal_compress",name:"Temporal-tensor compress",category:"sig",crate:"wifi-densepose-wasm-edge",summary:"RuVector temporal-tensor compression on the CSI buffer.",budget:"M",status:"available",tags:["compress","tensor"]},{id:"sig_sparse_recovery",name:"Sparse recovery",category:"sig",crate:"wifi-densepose-wasm-edge",summary:"114→56 subcarrier sparse interpolation via L1 solver.",budget:"M",status:"available",tags:["sparse","csi"]},{id:"sig_mincut_person_match",name:"Mincut person-match",category:"sig",crate:"wifi-densepose-wasm-edge",summary:"Min-cut person assignment across multistatic frames.",budget:"M",status:"available",tags:["mincut","matching"]},{id:"sig_optimal_transport",name:"Optimal transport",category:"sig",crate:"wifi-densepose-wasm-edge",summary:"OT-based feature alignment between mesh nodes.",budget:"M",status:"beta",tags:["ot","alignment"]},{id:"lrn_dtw_gesture_learn",name:"DTW gesture learn",category:"lrn",crate:"wifi-densepose-wasm-edge",summary:"On-device template learning for personalized gesture libraries.",budget:"M",status:"beta",tags:["lifelong","gesture"]},{id:"lrn_anomaly_attractor",name:"Anomaly attractor",category:"lrn",crate:"wifi-densepose-wasm-edge",summary:"Novelty detector with dynamic-attractor recall.",budget:"M",status:"research",tags:["novelty","lifelong"]},{id:"lrn_meta_adapt",name:"Meta-adapt",category:"lrn",crate:"wifi-densepose-wasm-edge",summary:"Meta-learning adapter for fast site-to-site transfer.",budget:"L",status:"research",tags:["meta-learning"]},{id:"lrn_ewc_lifelong",name:"EWC++ lifelong",category:"lrn",crate:"wifi-densepose-wasm-edge",summary:"Elastic-weight-consolidation gate to avoid catastrophic forgetting.",budget:"M",status:"beta",tags:["lifelong","ewc"]},{id:"spt_pagerank_influence",name:"PageRank influence",category:"spt",crate:"wifi-densepose-wasm-edge",summary:"Graph-influence ranking on the multistatic mesh.",budget:"M",status:"beta",tags:["graph","pagerank"]},{id:"spt_micro_hnsw",name:"µHNSW vector index",category:"spt",crate:"wifi-densepose-wasm-edge",summary:"Tiny HNSW index for AETHER re-ID embeddings on-device.",budget:"M",status:"available",tags:["hnsw","reid"]},{id:"spt_spiking_tracker",name:"Spiking tracker",category:"spt",crate:"wifi-densepose-wasm-edge",summary:"Spiking-network multi-target tracker.",budget:"L",status:"research",tags:["snn","tracker"]},{id:"tmp_pattern_sequence",name:"Pattern sequence",category:"tmp",crate:"wifi-densepose-wasm-edge",summary:"Sequence-of-events pattern matcher (e.g. ingress→linger→egress).",budget:"M",status:"available",tags:["temporal","pattern"]},{id:"tmp_temporal_logic_guard",name:"Temporal logic guard",category:"tmp",crate:"wifi-densepose-wasm-edge",summary:"LTL/MTL safety-property guard over event streams.",budget:"M",status:"beta",tags:["ltl","safety"]},{id:"tmp_goap_autonomy",name:"GOAP autonomy",category:"tmp",crate:"wifi-densepose-wasm-edge",summary:"Goal-oriented action planning for adaptive routines.",budget:"L",status:"research",tags:["planning","autonomy"]},{id:"ais_prompt_shield",name:"Prompt shield",category:"ais",crate:"wifi-densepose-wasm-edge",summary:"Edge-side LLM prompt-injection guard for on-device assistants.",budget:"M",status:"beta",tags:["security","llm"]},{id:"ais_behavioral_profiler",name:"Behavioral profiler",category:"ais",crate:"wifi-densepose-wasm-edge",summary:"Anomalous-behaviour profiler (drift in motion habits).",budget:"M",status:"beta",tags:["anomaly","behaviour"]},{id:"qnt_quantum_coherence",name:"Quantum coherence",category:"qnt",crate:"wifi-densepose-wasm-edge",summary:"Coherence diagnostics adapted for quantum-sensor signals.",budget:"M",status:"research",tags:["quantum","coherence"]},{id:"qnt_interference_search",name:"Interference search",category:"qnt",crate:"wifi-densepose-wasm-edge",summary:"Interferometric anomaly search across mesh viewpoints.",budget:"L",status:"research",tags:["quantum","interference"]},{id:"aut_psycho_symbolic",name:"Psycho-symbolic agent",category:"aut",crate:"wifi-densepose-wasm-edge",summary:"Symbolic-rule + neural-feature hybrid for low-power autonomy loops.",budget:"L",status:"research",tags:["autonomy","symbolic"]},{id:"aut_self_healing_mesh",name:"Self-healing mesh",category:"aut",crate:"wifi-densepose-wasm-edge",summary:"Mesh-topology repair with per-node health gossip.",budget:"M",status:"beta",tags:["mesh","health"]},{id:"exo_ghost_hunter",name:"Ghost hunter (anomaly)",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"Empty-room CSI anomaly detector — impulsive/periodic/drift/random + hidden-presence sub-detector.",events:[650,651,652,653],budget:"S",status:"available",tags:["anomaly","paranormal","csi"],adr:"ADR-041",runtime:"simulated"},{id:"exo_breathing_sync",name:"Breathing sync",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"Multi-person breathing synchrony analytics.",budget:"M",status:"beta",tags:["breathing","sync"]},{id:"exo_dream_stage",name:"Dream-stage classifier",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"NREM/REM stage classification from breathing + micro-motion.",budget:"M",status:"research",tags:["sleep","rem"]},{id:"exo_emotion_detect",name:"Emotion detector",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"Coarse arousal/valence from breathing + heart-rate variability.",budget:"M",status:"research",tags:["affect"]},{id:"exo_gesture_language",name:"Gesture language",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"Sign-language pattern recognition.",budget:"L",status:"research",tags:["hci","sign"]},{id:"exo_happiness_score",name:"Happiness score",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"Aggregate well-being score from co-occupancy + activity dynamics.",budget:"M",status:"research",tags:["affect","wellbeing"]},{id:"exo_hyperbolic_space",name:"Hyperbolic space embed",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"Hyperbolic embeddings for hierarchical scene structure.",budget:"L",status:"research",tags:["embedding","hyperbolic"]},{id:"exo_music_conductor",name:"Music conductor",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"Map gesture energy to MIDI tempo/dynamics.",budget:"M",status:"research",tags:["midi","art"]},{id:"exo_plant_growth",name:"Plant-growth tracker",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"Slow CSI drift tracking for greenhouse foliage growth.",budget:"L",status:"research",tags:["agriculture"]},{id:"exo_rain_detect",name:"Rain detector",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"Outdoor CSI signature of rainfall.",budget:"M",status:"research",tags:["weather"]},{id:"exo_time_crystal",name:"Time-crystal periodicity",category:"exo",crate:"wifi-densepose-wasm-edge",summary:"Periodicity diagnostics with anti-aliasing harmonics.",budget:"M",status:"research",tags:["periodicity"]}],_e={sim:{label:"Simulators",color:"oklch(0.78 0.14 70)",range:"—"},med:{label:"Medical & Health",color:"oklch(0.65 0.22 25)",range:"100–199"},sec:{label:"Security & Safety",color:"oklch(0.7 0.18 35)",range:"200–299"},bld:{label:"Smart Building",color:"oklch(0.78 0.12 195)",range:"300–399"},ret:{label:"Retail & Hospitality",color:"oklch(0.78 0.14 145)",range:"400–499"},ind:{label:"Industrial",color:"oklch(0.72 0.18 330)",range:"500–599"},sig:{label:"Signal Processing",color:"oklch(0.78 0.14 70)",range:"600–619"},lrn:{label:"Online Learning",color:"oklch(0.78 0.12 260)",range:"620–639"},spt:{label:"Spatial / Graph",color:"oklch(0.7 0.18 100)",range:"640–659"},tmp:{label:"Temporal / Planning",color:"oklch(0.7 0.16 50)",range:"660–679"},ais:{label:"AI Safety",color:"oklch(0.65 0.22 25)",range:"700–719"},qnt:{label:"Quantum",color:"oklch(0.72 0.18 290)",range:"720–739"},aut:{label:"Autonomy",color:"oklch(0.78 0.14 145)",range:"740–759"},exo:{label:"Exotic / Research",color:"oklch(0.72 0.18 330)",range:"650–699"}};function _a(){return ze.map(e=>({id:e.id,active:e.active===!0,eventCount:0}))}function Ta(e,t){if(!e)return 1;const a=e.toLowerCase();let s=0;return t.id.toLowerCase().includes(a)&&(s+=3),t.name.toLowerCase().includes(a)&&(s+=3),t.summary.toLowerCase().includes(a)&&(s+=1),t.tags?.some(i=>i.toLowerCase().includes(a))&&(s+=2),t.category===a&&(s+=5),s}const Ca="nvsim",Ma=1,me="kv";let je=null;function Lt(){return je||(je=new Promise((e,t)=>{const a=indexedDB.open(Ca,Ma);a.onupgradeneeded=()=>{const s=a.result;s.objectStoreNames.contains(me)||s.createObjectStore(me)},a.onsuccess=()=>e(a.result),a.onerror=()=>t(a.error)}),je)}async function W(e){const t=await Lt();return await new Promise((a,s)=>{const r=t.transaction(me,"readonly").objectStore(me).get(e);r.onsuccess=()=>a(r.result),r.onerror=()=>s(r.error)})}async function B(e,t){const a=await Lt();return await new Promise((s,i)=>{const r=a.transaction(me,"readwrite");r.objectStore(me).put(t,e),r.oncomplete=()=>s(),r.onerror=()=>i(r.error)})}function Oe(e){if(e.length===0)return 0;let t=0;for(const a of e)t+=a;return t/e.length}function gt(e){if(e.length<2)return 0;const t=Oe(e);let a=0;for(const s of e)a+=(s-t)*(s-t);return Math.sqrt(a/(e.length-1))}const Aa=e=>{if(e.bHistory.length<64)return null;const t=e.state.lastEmitS??0;if(e.elapsedS-t<1)return null;e.state.lastEmitS=e.elapsedS;const a=e.bHistory.slice(-64),s=Oe(a);let i=0;for(let u=1;u<a.length;u++)(a[u]-s)*(a[u-1]-s)<0&&i++;const r=i/2,n=Math.max(40,Math.min(180,Math.round(r/.65*60))),o=Math.max(8,Math.min(30,Math.round(n/4))),l=[{ts:Date.now(),appId:"vital_trend",eventId:100,eventName:"VITAL_TREND",value:n,detail:`HR≈${n} BPM, BR≈${o} br/min`}];return n<60?l.push({ts:Date.now(),appId:"vital_trend",eventId:103,eventName:"BRADYCARDIA",value:n,detail:`HR=${n} BPM`}):n>100&&l.push({ts:Date.now(),appId:"vital_trend",eventId:104,eventName:"TACHYCARDIA",value:n,detail:`HR=${n} BPM`}),o<12?l.push({ts:Date.now(),appId:"vital_trend",eventId:101,eventName:"BRADYPNEA",value:o,detail:`BR=${o} br/min`}):o>24&&l.push({ts:Date.now(),appId:"vital_trend",eventId:102,eventName:"TACHYPNEA",value:o,detail:`BR=${o} br/min`}),l},za=e=>{if(e.bHistory.length<32)return null;const t=e.state.lastEmitS??0;if(e.elapsedS-t<2)return null;const a=gt(e.bHistory.slice(-128))*1e9,s=a>.01,i=(e.state.occ??0)>.5;return s!==i?(e.state.occ=s?1:0,e.state.lastEmitS=e.elapsedS,{ts:Date.now(),appId:"occupancy",eventId:s?300:302,eventName:s?"ZONE_OCCUPIED":"ZONE_TRANSITION",value:a,detail:s?`σ(|B|)=${a.toFixed(3)} nT — entered`:`σ(|B|)=${a.toFixed(3)} nT — left`}):null},Pa=e=>{const t=e.state.ambient??e.bMagT;e.state.ambient=.95*t+.05*e.bMagT;const a=e.bMagT>t*1.5&&e.bMagT>1e-12,s=e.state.dwellStart??0;return a&&s===0?e.state.dwellStart=e.elapsedS:a||(e.state.dwellStart=0),a&&s>0&&e.elapsedS-s>.5&&(e.state.lastEmitS??0)<s?(e.state.lastEmitS=e.elapsedS,{ts:Date.now(),appId:"intrusion",eventId:200,eventName:"INTRUSION_ALERT",value:e.bMagT*1e9,detail:`|B|=${(e.bMagT*1e9).toFixed(2)} nT > 1.5× ambient (${(t*1e9).toFixed(2)} nT) for ${(e.elapsedS-s).toFixed(1)} s`}):null},Ea=e=>{if(e.bHistory.length<64)return null;const t=e.state.lastEmitS??0;if(e.elapsedS-t<.5)return null;e.state.lastEmitS=e.elapsedS;const a=e.bHistory.slice(-32),s=e.bHistory.slice(-128,-32);if(s.length<32)return null;const i=Oe(s),r=gt(s);if(r===0)return null;const n=Oe(a),o=Math.abs(n-i)/r;return{ts:Date.now(),appId:"coherence",eventId:2,eventName:"COHERENCE_SCORE",value:o,detail:`z=${o.toFixed(2)} σ ${o>3?"· DRIFT":o>1.5?"· marginal":"· stable"}`}},Ra=e=>{if(e.bHistory.length<32)return null;const t=e.state.lastEmitS??0;if(e.elapsedS-t<3)return null;const a=e.bHistory.slice(-32);let s=0;for(let i=1;i<a.length;i++){const r=Math.abs(Math.log(Math.max(a[i],1e-15))-Math.log(Math.max(a[i-1],1e-15)));r>s&&(s=r)}return s>5?(e.state.lastEmitS=e.elapsedS,{ts:Date.now(),appId:"adversarial",eventId:3,eventName:"ANOMALY_DETECTED",value:s,detail:`log-jump ${s.toFixed(1)} — physically implausible step in |B|`}):null},Da=e=>{if(e.bHistory.length<128)return null;const t=e.state.lastEmitS??0;if(e.elapsedS-t<4)return null;e.state.lastEmitS=e.elapsedS;const a=e.bHistory.slice(-128),s=gt(a)*1e9,i=Oe(a);let r=0;for(const l of a){const u=Math.abs(l-i);u>r&&(r=u)}const n=r>4*(s*1e-9)?1:e.elapsedS>10?3:4,o=n===1?"impulsive":n===3?"drift":"random";return{ts:Date.now(),appId:"exo_ghost_hunter",eventId:651,eventName:"ANOMALY_CLASS",value:n,detail:`class=${o} · σ=${s.toFixed(3)} nT`}},Wt={vital_trend:Aa,occupancy:za,intrusion:Pa,coherence:Ea,adversarial:Ra,exo_ghost_hunter:Da};function Ia(e){return e in Wt}var Oa=Object.defineProperty,Fa=Object.getOwnPropertyDescriptor,Bt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Fa(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Oa(t,a,i),i};const G=p(_a()),Te=p(""),Q=p("all"),E=p("all");(async()=>{const e=await W("app-activations");e&&(G.value=e)})();f(()=>{const e=G.value;e.length>0&&B("app-activations",e);const t=new Set;for(const a of e)a.active&&t.add(a.id);Ot.value=t});let Ze=class extends k{constructor(){super(...arguments),this.renderTick=0}connectedCallback(){super.connectedCallback(),f(()=>{G.value,Te.value,Q.value,E.value,Xe.value,Qe.value,this.renderTick++})}isActive(e){return G.value.find(t=>t.id===e)?.active===!0}toggle(e){const t=this.isActive(e.id),a=G.value.map(s=>s.id===e.id?{...s,active:!s.active,lastActivatedAt:Date.now()}:s);if(G.value=a,t)c("info",`app <span class="k">${e.id}</span> deactivated`);else{const s=e.runtime??"mesh-only",i=s==="simulated"?" · live runtime engaged":s==="mesh-only"?" · queued (needs ESP32 mesh)":"";c("ok",`app <span class="k">${e.id}</span> activated${i}`)}}filtered(){let e=ze;return Q.value!=="all"&&(e=e.filter(t=>t.category===Q.value)),E.value!=="all"&&(e=e.filter(t=>t.status===E.value)),Te.value.trim()&&(e=e.map(t=>({a:t,s:Ta(Te.value,t)})).filter(t=>t.s>0).sort((t,a)=>a.s-t.s).map(t=>t.a)),e}categoryCounts(){const e={all:ze.length};for(const t of Object.keys(_e))e[t]=0;for(const t of ze)e[t.category]=(e[t.category]??0)+1;return e}render(){const e=this.filtered(),t=this.categoryCounts(),a=G.value.filter(s=>s.active).length;return d`
    ...
    `}renderEventsFeed(){const e=Xe.value.slice(-12).reverse(),t=G.value.filter(a=>a.active&&Ia(a.id)).length;return d`
  ...
  `;Bt([v()],Ze.prototype,"renderTick",2);Ze=Bt([$("nv-app-store")],Ze);var Na=Object.defineProperty,Ha=Object.getOwnPropertyDescriptor,We=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ha(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Na(t,a,i),i};let re=class extends k{constructor(){super(...arguments),this.open=!1,this.filter="",this.idx=0,this.cmds=[{ico:"▶",label:"Run pipeline",kbd:"Space",run:async()=>{await S()?.run(),g.value=!0,U("Pipeline running","▶")}},{ico:"❚",label:"Pause pipeline",run:async()=>{await S()?.pause(),g.value=!1,U("Paused","❚❚")}},{ico:"+",label:"New scene…",kbd:"⌘N",run:()=>Ae({title:"New scene",body:`<p>Build a fresh magnetic scene. The dashboard generates the JSON
        ...
        </select>`,buttons:[{label:"Cancel",variant:"ghost"},{label:"Create",variant:"primary",onClick:async()=>{const e=document.querySelector("nv-app")?.shadowRoot?.querySelector("nv-modal")?.shadowRoot;if(!e)return;const t=(e.querySelector("#ns-name")?.value??"custom").trim(),a=parseFloat(e.querySelector("#ns-moment")?.value??"1e-6"),s=parseFloat(e.querySelector("#ns-distance")?.value??"0.5"),i=e.querySelector("#ns-ferrous")?.value==="1",r=e.querySelector("#ns-mains")?.value==="1",n={dipoles:[{position:[0,0,s],moment:[0,0,a]}],loops:r?[{centre:[0,1,0],normal:[0,1,0],radius:.05,current:2,n_segments:64}]:[],ferrous:i?[{position:[1,0,0],volume:1e-4,susceptibility:5e3}]:[],eddy:[],sensors:[[0,0,0]],ambient_field:[1e-6,0,0]};await S()?.loadScene(n),c("ok",`scene <span class="s">${t}</span> loaded · 1 dipole · ${r?"1 loop · ":""}${i?"1 ferrous · ":""}1 sensor`),U(`Scene "${t}" loaded`,"+")}}]})},{ico:"📦",label:"Export proof bundle…",kbd:"⌘E",run:async()=>{const e=S();if(e){c("dbg","building proof bundle…");try{const t=await e.exportProofBundle(),a=URL.createObjectURL(t),s=document.createElement("a");s.href=a,s.download=`nvsim-proof-${Date.now()}.json`,s.click(),URL.revokeObjectURL(a),c("ok",`proof bundle exported · ${t.size} bytes`),U(`Proof bundle saved (${t.size} B)`,"📦")}catch(t){c("err",`export failed: ${t.message}`)}}}},{ico:"⟳",label:"Reset pipeline",kbd:"⌘R",run:()=>Ae({title:"Reset pipeline?",body:"<p>Clears the frame stream and rewinds <code>t</code> to 0.</p>",buttons:[{label:"Cancel",variant:"ghost"},{label:"Reset",variant:"danger",onClick:async()=>{await S()?.reset(),c("warn","pipeline reset · t=0"),U("Pipeline reset","⟳")}}]})},{ico:"✓",label:"Verify witness",run:async()=>{const e=S();if(!e)return;C.value="pending";const t=V.value,a=new Uint8Array(32);for(let i=0;i<32;i++)a[i]=parseInt(t.slice(i*2,i*2+2),16);(await e.verifyWitness(a)).ok?(C.value="ok",F.value=t,U("Witness verified","✓")):(C.value="fail",U("Witness mismatch!","✗"))}},{ico:"☼",label:"Toggle theme",kbd:"⌘/",run:()=>{T.value=T.value==="dark"?"light":"dark"}},{ico:"⚙",label:"Open settings",kbd:"⌘,",run:()=>window.dispatchEvent(new CustomEvent("open-settings"))},{ico:"?",label:"Keyboard shortcuts…",run:()=>Ae({title:"Keyboard shortcuts",body:`<div style="display:grid;grid-template-columns:auto 1fr;gap:6px 16px;font-size:13px;">
      ...
      </div>`,buttons:[{label:"Close",variant:"primary"}]})},{ico:"i",label:"About nvsim…",run:()=>Ae({title:"About nvsim",body:`<p><b>nvsim</b> is a deterministic, byte-reproducible forward simulator for nitrogen-vacancy diamond magnetometry.</p>
  ...
  `;We([v()],re.prototype,"open",2);We([v()],re.prototype,"filter",2);We([v()],re.prototype,"idx",2);We([Dt("#palette-input")],re.prototype,"inputEl",2);re=We([$("nv-palette")],re);var La=Object.defineProperty,Wa=Object.getOwnPropertyDescriptor,bt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Wa(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&La(t,a,i),i};let Fe=class extends k{constructor(){super(...arguments),this.open=!1,this.renderFps=0,this.lastTs=performance.now(),this.frameCount=0,this.rafId=0,this.onKey=e=>{e.key==="`"&&!e.target.matches("input, textarea")&&(this.open=!this.open,this.toggleAttribute("open",this.open))},this.tick=()=>{this.rafId=requestAnimationFrame(this.tick);const e=performance.now();this.frameCount++,e-this.lastTs>=500&&(this.renderFps=this.frameCount*1e3/(e-this.lastTs),this.frameCount=0,this.lastTs=e,this.requestUpdate())}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this.onKey),f(()=>{M.value,ct.value,se.value,ee.value,sa.value,this.requestUpdate()}),this.tick()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this.onKey),cancelAnimationFrame(this.rafId)}render(){return d`
      ...
      <div class="row"><span class="k">frames</span><span class="v">${ct.value.toString()}</span></div>
      <div class="row"><span class="k">|B|</span><span class="v">${(se.value*1e9).toFixed(3)} nT</span></div>
      <div class="row"><span class="k">SNR</span><span class="v">${ee.value>0?ee.value.toFixed(1):"—"}</span></div>
    ...
    .k { color: var(--ink-3); }
    .v { color: var(--ink); }
  `;bt([v()],Fe.prototype,"open",2);bt([v()],Fe.prototype,"renderFps",2);Fe=bt([$("nv-debug-hud")],Fe);var Ba=Object.defineProperty,Va=Object.getOwnPropertyDescriptor,Vt=(e,t,a,s)=>{for(var i=s>1?void 0:s?Va(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Ba(t,a,i),i};let et=class extends k{constructor(){super(...arguments),this.open=!1}connectedCallback(){super.connectedCallback(),f(()=>{T.value,O.value,N.value,Se.value,P.value,R.value,this.requestUpdate()}),window.addEventListener("open-settings",()=>{this.open=!0,this.setAttribute("open","")})}close(){this.open=!1,this.removeAttribute("open")}async resetPrefs(){if(confirm("Reset all preferences and IndexedDB state? Reloads the page.")){try{const e=await indexedDB.databases?.();if(e)for(const t of e)t.name&&indexedDB.deleteDatabase(t.name)}catch{}location.reload()}}render(){return d`
      ...
      <div class="body">
        <div class="group">
          ...
          <div class="row">
            ...
            <div class="seg">
              <button class=${O.value==="comfy"?"on":""}
                @click=${()=>O.value="comfy"}>comfy</button>
              <button class=${O.value==="default"?"on":""}
                @click=${()=>O.value="default"}>default</button>
              <button class=${O.value==="compact"?"on":""}
                @click=${()=>O.value="compact"}>compact</button>
            </div>
          </div>
          <div class="row">
            <div>
            ...
            <span class="toggle ${N.value?"on":""}"
              role="switch" aria-checked=${N.value}
              @click=${()=>N.value=!N.value}></span>
          </div>
        </div>
        ...
        <div class="group">
          ...
          <div class="row">
            ...
            <span class="toggle ${Se.value?"on":""}"
              role="switch" aria-checked=${Se.value}
        ...
        <div class="group">
          ...
          <div class="row">
            ...
            <div class="seg">
              <button class=${P.value==="wasm"?"on":""}
                @click=${()=>P.value="wasm"}>WASM</button>
              <button class=${P.value==="ws"?"on":""}
                @click=${()=>P.value="ws"}>WS</button>
            </div>
          </div>
          ${P.value==="ws"?d`
            <div class="row">
              ...
              <input type="text" placeholder="ws://localhost:7878" .value=${R.value}
  ...
  `;Vt([v()],et.prototype,"open",2);et=Vt([$("nv-settings-drawer")],et);var qa=Object.defineProperty,Ua=Object.getOwnPropertyDescriptor,ft=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ua(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&qa(t,a,i),i};const J=[{icon:"👋",title:"Welcome to nvsim",body:`<p style="font-size:14px; line-height:1.6;">
      ...
      <p style="font-size:12.5px; color:var(--ink-3);">
        ...
        hot-loadable WASM edge module WeView ships, organised by category:
      ...
      <p style="font-size:12.5px; color:var(--ink-3); line-height:1.55;">
        Source: <code>github.com/ruvnet/WeView</code> · Apache-2.0 OR MIT ·
        ADRs 089/090/091/092/093.</p>`,cta:{label:"Get started →"}}];let Ne=class extends k{constructor(){super(...arguments),this.open=!1,this.step=0,this.show=()=>{this.step=0,this.open=!0,this.setAttribute("open","")}}async connectedCallback(){super.connectedCallback(),window.addEventListener("nv-show-tour",this.show),await W("onboarding-seen")||(this.open=!0,this.setAttribute("open",""))}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("nv-show-tour",this.show)}async dismiss(){this.open=!1,this.removeAttribute("open"),await B("onboarding-seen",!0)}next(){J[this.step].cta?.run?.(),this.step<J.length-1?this.step++:this.dismiss()}prev(){this.step>0&&this.step--}render(){const e=J[this.step],t=this.step===J.length-1;return d`
      <div class="card" role="dialog" aria-modal="true" aria-label="Welcome tour">
        <div class="h">
          <div class="icon" aria-hidden="true">${e.icon}</div>
          <div class="title-wrap">
            <h2>${e.title}</h2>
            <div class="step-label">Step ${this.step+1} of ${J.length}</div>
          </div>
          <button class="skip" @click=${()=>this.dismiss()} aria-label="Skip tour" title="Skip tour">×</button>
        </div>
        <div class="body">
          <div .innerHTML=${e.body}></div>
          ${e.hint?d`<div class="hint">${e.hint}</div>`:""}
        </div>
        <div class="footer">
          <div class="progress">
            <div class="dots">
            ...
            <div class="progress-label">${this.step+1} / ${J.length}</div>
          </div>
          ${this.step>0?d`<button class="ghost" @click=${()=>this.prev()}>← Back</button>`:d`<button class="ghost" @click=${()=>this.dismiss()}>Skip</button>`}
    ...
    button.primary:hover { filter: brightness(1.08); }
  `;ft([v()],Ne.prototype,"open",2);ft([v()],Ne.prototype,"step",2);Ne=ft([$("nv-onboarding")],Ne);var ja=Object.defineProperty,Ga=Object.getOwnPropertyDescriptor,we=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ga(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ja(t,a,i),i};const Ka=[{id:"nvBest",label:"NV-ensemble (best lab)",floorT:1e-12,color:"oklch(0.78 0.14 70)"},{id:"nvCots",label:"NV-DNV-B1 (COTS)",floorT:3e-10,color:"oklch(0.72 0.18 50)"},{id:"squid",label:"SQUID (shielded room)",floorT:1e-15,color:"oklch(0.78 0.12 195)"},{id:"mmw",label:"60 GHz mmWave (μ-Doppler)",floorT:0,color:"oklch(0.78 0.14 145)"},{id:"csi",label:"WiFi CSI (presence)",floorT:0,color:"oklch(0.72 0.18 330)"}];let X=class extends k{constructor(){super(...arguments),this.distanceM=.1,this.momentLog10=-8.3,this.result=null,this.running=!1,this.err=null}predictedDipoleFieldT(e,t){return 4*Math.PI*1e-7*t/(4*Math.PI*Math.pow(Math.max(e,1e-6),3))}async runDemo(){const e=S();if(!e){this.err="WASM client not ready";return}this.err=null,this.running=!0,this.requestUpdate();try{const t=this.distanceM,a=Math.pow(10,this.momentLog10),s={dipoles:[{position:[0,0,t],moment:[0,0,a]}],loops:[],ferrous:[],eddy:[],sensors:[[0,0,0]],ambient_field:[0,0,0]},i={digitiser:{f_s_hz:1e4,f_mod_hz:1e3},sensor:{gamma_fwhm_hz:1e6,t1_s:.005,t2_s:1e-6,t2_star_s:2e-7,contrast:.03,n_spins:1e12,shot_noise_disabled:!1},dt_s:null};this.result=await e.runTransient(s,i,42n,64),c("ok",`ghost-demo · r=${t.toFixed(3)} m · |B| recovered = ${(this.result.bMagT*1e12).toExponential(2)} pT`)}catch(t){this.err=t.message,c("err",`ghost-demo failed: ${this.err}`)}finally{this.running=!1,this.requestUpdate()}}formatField(e){if(e===0)return"0 T";const t=Math.abs(e);return t>=.001?`${(e*1e3).toFixed(2)} mT`:t>=1e-6?`${(e*1e6).toFixed(2)} µT`:t>=1e-9?`${(e*1e9).toFixed(3)} nT`:t>=1e-12?`${(e*1e12).toFixed(2)} pT`:t>=1e-15?`${(e*1e15).toFixed(2)} fT`:t>=1e-18?`${(e*1e18).toFixed(2)} aT`:`${e.toExponential(2)} T`}formatDistance(e){return e<1?`${(e*100).toFixed(1)} cm`:e<1e3?`${e.toFixed(2)} m`:e<1e5?`${(e/1e3).toFixed(2)} km`:`${(e/1609).toFixed(0)} mi`}renderDemo(){const e=Math.pow(10,this.momentLog10),t=this.predictedDipoleFieldT(this.distanceM,e),a=this.result?.bMagT??0,s=(this.result?.noiseFloorPtSqrtHz??0)*1e-12,i=Ka.map(o=>{let l="bad",u="below floor";if(o.id==="mmw")this.distanceM<=5?(l="ok",u="µ-Doppler @ chest"):this.distanceM<=15?(l="warn",u="edge of range"):(l="bad",u="out of range");else if(o.id==="csi")this.distanceM<=30?(l=this.distanceM<=10?"ok":"warn",u="presence/breathing"):(l="bad",u="out of range");else if(o.floorT>0){const b=t/o.floorT;b>100?(l="ok",u=`${b.toExponential(1)}× floor`):b>1?(l="warn",u=`${b.toFixed(1)}× floor`):(l="bad",u=`${(1/b).toExponential(1)}× too weak`)}const h=o.floorT>0?Math.max(2,Math.min(100,100+12*Math.log10(t/o.floorT))):o.id==="mmw"?Math.max(2,100-this.distanceM*7):Math.max(2,100-this.distanceM*2);return d`
        <div class="tier-bar" data-tier=${o.id}>
          <div class="fill" style=${`width:${h}%; background:${o.color}; border-color:${o.color}`}></div>
          <div class="lbl">
            <span>${o.label}</span>
            <span class="verdict-${l}" style=${`color:${l==="ok"?"var(--ok)":l==="warn"?"var(--warn)":"var(--bad)"}`}>${u}</span>
          </div>
        </div>
    ...
    `}render(){return d`
      ...
      <div class="subtitle">
        ...
        CIA NV-diamond heartbeat detector, and how WeView's existing
        stack maps onto an honest, civilian version of the same idea.
      </div>

      <div class="links">
        <a href="https://github.com/ruvnet/WeView/blob/feat/nvsim-pipeline-simulator/docs/research/quantum-sensing/16-ghost-murmur-weview-spec.md" target="_blank" rel="noopener">
          📄 Full spec (583 lines)
        </a>
        <a href="https://gist.github.com/ruvnet/e44d0c3f0ad10d9c4933a196a16d405c" target="_blank" rel="noopener">
          ✦ Public gist
        </a>
        <a href="https://github.com/ruvnet/WeView/issues/437" target="_blank" rel="noopener">
          # Issue #437
        </a>
      ...
      <h2>WeView's three-tier mesh — what is actually buildable</h2>
      ...
      <h2>Press claim → WeView equivalent</h2>
      <div class="card" style="padding: 6px 14px;">
        <table>
          <thead>
            <tr><th>Press claim</th><th>WeView equivalent today</th><th>Crate / ADR</th><th>Honest range</th></tr>
          </thead>
          <tbody>
            <tr>
      ...
      <div class="ethics">
        ...
        <ul>
          ...
          <li><b>No export-controlled hardware</b> — WeView targets &lt; $50 COTS. ITAR/EAR sub-THz coherent radars and shielded NV ensembles are out of scope.</li>
        </ul>
        <p style="font-size: 11.5px; color: var(--ink-3); margin: 10px 0 0;">
          WeView is not affiliated with the United States government, the CIA, Lockheed Martin,
  ...
  `;we([v()],X.prototype,"distanceM",2);we([v()],X.prototype,"momentLog10",2);we([v()],X.prototype,"result",2);we([v()],X.prototype,"running",2);we([v()],X.prototype,"err",2);X=we([$("nv-ghost-murmur")],X);var Ya=Object.defineProperty,Xa=Object.getOwnPropertyDescriptor,st=(e,t,a,s)=>{for(var i=s>1?void 0:s?Xa(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Ya(t,a,i),i};const _t=[{term:"NV-diamond",category:"physics",body:"Nitrogen-vacancy defect in synthetic diamond. The simulator models a 1 mm³ ensemble (~10¹² centers) addressed by 532 nm pump light + a 2.87 GHz microwave drive. Used as a room-temperature magnetometer with shot-noise floor ~1 pT/√Hz at the published lab record."},{term:"CW-ODMR",category:"physics",body:"Continuously-driven optically-detected magnetic resonance. Sweep the microwave frequency around the NV zero-field splitting (D = 2.87 GHz) and watch the photoluminescence dip when the microwave matches the spin transition. The dip splits with applied magnetic field along each of the four ⟨111⟩ NV axes."},{term:"MagFrame",category:"rust",body:"Fixed-layout 60-byte binary record nvsim emits per (sensor × sample). Magic 0xC51A_6E70, version 1, little-endian. Carries timestamp, recovered B vector (pT), per-axis sigma, noise floor, and flag bits for saturation / shot-noise-disabled / heavy-attenuation."},{term:"Witness",category:"rust",body:"SHA-256 hash over the concatenated MagFrame bytes for a canonical reference run (Proof::REFERENCE_SCENE_JSON @ seed=42, N=256). Same inputs → same hash, byte-for-byte, across runs and machines. The dashboard re-derives it in WASM and compares against Proof::EXPECTED_WITNESS_HEX pinned at build time."},{term:"Determinism gate",category:"rust",body:"A pass/fail check: did this build of nvsim produce the expected witness? If yes → every constant (γ_e, D_GS, μ₀, contrast, T₂*, the PRNG stream, the frame layout, the pipeline ordering) is byte-identical to the published reference. If no → something drifted; the dashboard names which."},{term:"Lock-in demod",category:"physics",body:"Multiply the photoluminescence signal by cos(2π·f_mod·t) and low-pass to recover the slowly-varying B-field component. The simulator emulates a lock-in with output gain 2 and a single-pole IIR LP filter; settable via the Tunables panel (f_mod default 1 kHz)."},{term:"Shot-noise floor",category:"physics",body:'δB = 1 / (γ_e · C · √(N · t · T₂*)) — the irreducible quantum noise floor for an NV ensemble. With nvsim defaults (N=10¹², C=0.03, T₂*=200 ns): ≈1.18 pT/√Hz. Toggleable via the Tunables panel for "analytic" runs without noise.'},{term:"Biot-Savart",category:"physics",body:"Closed-form magnetic field at a point from a current loop or a magnetic dipole. The Scene panel's sources (heart proxy, mains loop, ferrous body, eddy current) all reduce to Biot-Savart-style superpositions over the sensor position."},{term:"Multistatic fusion",category:"physics",body:"Combining evidence from multiple sensors at known geometric configurations. WeView's Cramer-Rao-weighted attention over WiFi CSI nodes + 60 GHz radar nodes + (hypothetically) NV nodes; documented in ADR-029 and the Ghost Murmur view."},{term:"Scene",category:"ui",body:'The simulated magnetic environment: a list of sources (dipole, current loop, ferrous body, eddy current) plus one or more sensor positions and an ambient field. The dashboard ships a "rebar-walkby-01" reference scene; click "New scene…" in the command palette (⌘K) to build your own.'},{term:"Tunables",category:"ui",body:"Sliders that change the running pipeline's digitiser config. Each edit debounces 300 ms, then rebuilds the WASM pipeline with the new f_s / f_mod / dt / shot-noise setting. The frame stream picks up the change without a restart."},{term:"Transport",category:"ui",body:"How the dashboard talks to nvsim. Default is WASM — the simulator runs in a Web Worker right here in your browser, no server. The optional WS transport is REST + binary WebSocket against a host-supplied nvsim-server (see ADR-092 §6.2). Toggle in Settings."},{term:"App Store",category:"ui",body:"Catalog of all 65+ hot-loadable WASM edge modules from wifi-densepose-wasm-edge plus the simulators. Each card carries id / category / status / event IDs; the toggle marks an app active in this session and (in WS mode) pushes the activation to a connected ESP32 mesh."},{term:"Ghost Murmur",category:"ui",body:'Research view that audits the publicly-reported April 2026 CIA NV-diamond heartbeat detector against the open physics literature. Includes a live "Try it yourself" sandbox where you can place a heart dipole at any distance from the sensor and ask: which transport tier would actually detect it?'}],Qa=[{q:"Is this a real simulator or a mockup?",a:"Real. The Rust crate at v2/crates/nvsim is the same code that runs in the browser via WASM. Press <b>Verify witness</b> on the Witness panel — the SHA-256 you see is byte-equivalent to what `cargo test -p nvsim` produces."},{q:'Why does my "Recovered |B|" sit much higher than "Predicted |B|" in the Ghost Murmur demo?',a:"The recovered value reads the simulator's ADC quantization floor, not the actual magnetic signal. With COTS-default sensor noise (~300 pT/√Hz) and 16-bit ADC at ±10 µT FS, anything below ~1 pT vanishes into ~2 nT of digitization residual. That's the lesson — the press claim sits far below this floor at any meaningful range."},{q:"Can I run my own scene?",a:'Yes. Press ⌘K to open the command palette and pick "New scene…". You get five fields (name, dipole moment, distance, ferrous toggle, mains toggle); the dashboard builds the JSON and pushes it via <code>client.loadScene()</code>.'},{q:"Does any of my data leave the browser?",a:"No. WASM mode is local-only — the worker, the WASM binary, and the IndexedDB persistence all live in your browser. The optional WS transport (off by default) talks to a host of your choosing."},{q:"What does the witness mismatch (red ✗) mean?",a:"The current build of nvsim produced a SHA-256 that doesn't match the constant pinned at compile time. Possible causes: a different Rust toolchain, a dependency version drift, a manual edit to a physics constant, or an honest bug. Audit the diff against ADR-089 §5."},{q:"Why are the Inspector / Witness rail buttons there if there's already a right-side inspector?",a:'The right-side inspector is the compact live view; the rail buttons open a full-width version with bigger charts, an explainer header, reference-scene metadata cards, and (on Witness) a "what this verifies" panel. Both stay in sync — the right rail is for glancing, the main area is for diving in.'},{q:'Why is there an "App Store" if this is a magnetometer simulator?',a:"Because nvsim is one tile in a larger sensing platform. The catalog lists every hot-loadable WASM edge module WeView ships — medical, security, building, retail, industrial, signal, learning, autonomy. The simulators (nvsim today, more in future) are first-class entries in the same catalog."}],Ja=[{step:1,title:"Hit ▶ Run",body:"The big amber button in the topbar starts the live frame stream. The pipeline runs ~1.8 kHz on x86_64 WASM, well above the 1 kHz Cortex-A53 acceptance gate."},{step:2,title:"Watch the B-vector trace",body:"The Inspector → Signal tab shows the recovered field per axis updating in real time. The frame strip below it is one bar per ~32-frame batch."},{step:3,title:"Verify the witness",body:"Click the rail Witness button (or REPL: <code>proof.verify</code>). The dashboard re-runs the canonical reference scene and asserts the SHA-256 byte-for-byte."},{step:4,title:"Drag a source",body:"Grab the rebar / heart proxy / mains loop / ferrous door in the scene canvas; positions persist via IndexedDB."},{step:5,title:"Tweak the tunables",body:"Sliders in the left sidebar update the running pipeline (f_s, f_mod, integration time, shot-noise). Changes debounce 300 ms then push to the worker."},{step:6,title:"Open the Ghost Murmur view",body:'The ghost icon in the rail. Move the distance + moment sliders, hit "Run nvsim at this distance" — the live demo runs the real Rust pipeline through WASM and shows which transport tier would actually detect.'},{step:7,title:"Browse the App Store",body:"The grid icon. 65+ edge apps: medical, security, building, retail, industrial, signal, learning. Toggle to mark active in this session."}],Za=[{keys:"⌘K  /  Ctrl K",label:"Command palette"},{keys:"Space",label:"Play / pause pipeline"},{keys:"⌘R  /  Ctrl R",label:"Reset pipeline (with confirm)"},{keys:"⌘,  /  Ctrl ,",label:"Settings drawer"},{keys:"⌘N  /  Ctrl N",label:"New scene"},{keys:"⌘E  /  Ctrl E",label:"Export proof bundle"},{keys:"⌘/  /  Ctrl /",label:"Toggle theme (dark / light)"},{keys:"`",label:"Toggle debug HUD"},{keys:"?",label:"Open this help center"},{keys:"1 · 2 · 3",label:"Switch inspector tab (Signal / Frame / Witness)"},{keys:"Esc",label:"Close any modal / palette / drawer"},{keys:"/",label:"Focus the REPL prompt"}];let ge=class extends k{constructor(){super(...arguments),this.open=!1,this.section="quickstart",this.query="",this.closeListener=()=>this.close(),this.show=e=>{const t=e.detail;t?.section&&(this.section=t.section),this.open=!0,this.setAttribute("open","")},this.onKey=e=>{const t=e.target,a=t?.tagName==="INPUT"||t?.tagName==="TEXTAREA";e.key==="?"&&!a&&!e.ctrlKey&&!e.metaKey?(e.preventDefault(),this.show(new CustomEvent("nv-show-help"))):e.key==="Escape"&&this.open&&this.close()}}connectedCallback(){super.connectedCallback(),window.addEventListener("nv-show-help",this.show),window.addEventListener("nv-show-help-close",this.closeListener),window.addEventListener("keydown",this.onKey)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("nv-show-help",this.show),window.removeEventListener("nv-show-help-close",this.closeListener),window.removeEventListener("keydown",this.onKey)}close(){this.open=!1,this.removeAttribute("open")}filteredGlossary(){if(!this.query.trim())return _t;const e=this.query.toLowerCase();return _t.filter(t=>t.term.toLowerCase().includes(e)||t.body.toLowerCase().includes(e))}renderQuickstart(){return d`
      ...
      `)}
    `}renderGlossary(){const e=this.filteredGlossary();return d`
      <h2>Glossary</h2>
      ...
      ${e.length===0?d`<p style="color: var(--ink-3);">No terms match.</p>`:e.map(t=>d`
            <div class="term">
              <div class="head">
    ...
    `}renderAbout(){return d`
      ...
      <p>The codebase is open source (Apache-2.0 OR MIT). Find it on GitHub:
        <code>github.com/ruvnet/WeView</code>. Decisions are documented in ADRs 089 (nvsim),
        090 (Lindblad extension, conditional), 091 (sub-THz radar research),
        092 (this dashboard), 093 (UX gap analysis).</p>
      <p>This dashboard is one of several WeView demos. Sibling demos at
        <code>github.io/WeView/</code> include the Observatory and Pose Fusion views.</p>
    `}render(){return d`
      <div class="modal" role="dialog" aria-modal="true" aria-label="Help center">
        ...
        <nav class="nav" role="tablist" aria-label="Help sections">
          ${["quickstart","glossary","faq","shortcuts","about"].map(e=>d`
  ...
  `;st([v()],ge.prototype,"open",2);st([v()],ge.prototype,"section",2);st([v()],ge.prototype,"query",2);ge=st([$("nv-help")],ge);var es=Object.getOwnPropertyDescriptor,ts=(e,t,a,s)=>{for(var i=s>1?void 0:s?es(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(i)||i);return i};let mt=class extends k{connectedCallback(){super.connectedCallback(),f(()=>{g.value,C.value,M.value,this.requestUpdate()})}go(e){if(e==="tour"){window.dispatchEvent(new CustomEvent("nv-show-tour"));return}if(e==="help"){window.dispatchEvent(new CustomEvent("nv-show-help"));return}this.dispatchEvent(new CustomEvent("navigate",{detail:e,bubbles:!0,composed:!0}))}async runDemo(){const e=S();e&&(g.value||(await e.run(),g.value=!0,c("ok","demo started · streaming MagFrames")))}render(){const e=g.value,t=C.value==="ok";return d`
      <div class="hero">
        ...
        <div class="status ${e?"live":""}">
          <span class="dot"></span>
          ${e?d`Live · ${M.value>0?(M.value/1e3).toFixed(2)+" kHz":"starting…"}${t?" · witness verified ✓":""}`:d`Idle${t?" · witness verified ✓":""}`}
        </div>
      </div>
      ...
      <p class="footnote">
        ...
        Open source · Apache-2.0 OR MIT · <code>github.com/ruvnet/WeView</code>
      </p>
    `}};mt.styles=w`
    :host {
      display: block;
  ...
  `;mt=ts([$("nv-home")],mt);const as="modulepreload",ss=function(e){return"/WeView/nvsim/"+e},Tt={},is=function(t,a,s){let i=Promise.resolve();if(a&&a.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),o=n?.nonce||n?.getAttribute("nonce");i=Promise.allSettled(a.map(l=>{if(l=ss(l),l in Tt)return;Tt[l]=!0;const u=l.endsWith(".css"),h=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${h}`))return;const b=document.createElement("link");if(b.rel=u?"stylesheet":as,u||(b.as="script"),b.crossOrigin="",b.href=l,o&&b.setAttribute("nonce",o),document.head.appendChild(b),u)return new Promise((y,A)=>{b.addEventListener("load",y),b.addEventListener("error",()=>A(new Error(`Unable to preload CSS for ${l}`)))})}))}function r(n){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=n,window.dispatchEvent(o),!o.defaultPrevented)throw n}return i.then(n=>{for(const o of n||[])o.status==="rejected"&&r(o.reason);return t().catch(r)})},Ct=.7,dt=.3,rs=500,ns=[[5,7],[7,9],[6,8],[8,10],[5,6],[5,11],[6,12],[11,12],[11,13],[13,15],[12,14],[14,16],[0,5],[0,6]],yt=["nose","left_eye","right_eye","left_ear","right_ear","left_shoulder","right_shoulder","left_elbow","right_elbow","left_wrist","right_wrist","left_hip","right_hip","left_knee","right_knee","left_ankle","right_ankle"];let Mt=0,qt="";function os(e){qt=e}async function At(e,t){const a=Date.now();if(a-Mt<rs)return;Mt=a;const s=qt||`http://${window.location.hostname}:8080`;try{await fetch(`${s}/api/v1/camera-hint`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({person_count:e,confidence:t,source:"mediapipe"})})}catch{}}function ls(e,t,a){return{name:e.name,x:e.x*a+t.x*(1-a),y:e.y*a+t.y*(1-a),z:e.z*a+t.z*(1-a),confidence:e.confidence*a+t.confidence*(1-a)}}function ds(e,t,a){const s=e.keypoints.map((i,r)=>{const n=t.keypoints[r];return n?ls(i,n,a):i});return{id:e.id,source:"blend",confidence:e.confidence*a+t.confidence*(1-a),keypoints:s}}function cs(){const e=q.value,t=pt.value,a=Ft.value,s=K.value;let i,r;if(!s||e<dt)i="wifi",r=a.map(n=>({...n,source:"wifi"}));else if(e>=Ct)i="camera",r=t.map(n=>({...n,source:"camera"})),At(t.length,e);else{i="blend";const n=(e-dt)/(Ct-dt),o=Math.max(t.length,a.length);r=[];for(let l=0;l<o;l++){const u=t[l],h=a[l];u&&h?r.push(ds(u,h,n)):u?r.push({...u,source:"blend"}):h&&r.push({...h,source:"blend"})}At(r.length,e)}r=r.slice(0,3),Ie.value=i,ut.value=r}let zt=!1;function ps(){zt||(zt=!0,f(cs))}function us(e){if(typeof e!="object"||e===null)return;const t=e,a=typeof t.estimated_persons=="number"?t.estimated_persons:0;De.value=Math.min(a,3);const i=(Array.isArray(t.persons)?t.persons:[]).slice(0,3).map((r,n)=>{const o=r,l=Array.isArray(o.keypoints)?o.keypoints.slice(0,17).map(u=>{const h=u;return{name:typeof h.name=="string"?h.name:yt[n]??"unknown",x:typeof h.x=="number"?h.x:320,y:typeof h.y=="number"?h.y:240,z:typeof h.z=="number"?h.z:0,confidence:typeof h.confidence=="number"?h.confidence:.5}}):hs(n,a);return{id:typeof o.id=="number"?o.id:n+1,source:"wifi",confidence:typeof o.confidence=="number"?o.confidence:.5,keypoints:l}});Ft.value=i}function hs(e,t){const s=640/(t+1)*(e+1),i=[[0,-80],[-8,-88],[8,-88],[-16,-82],[16,-82],[-30,-50],[30,-50],[-45,-15],[45,-15],[-50,20],[50,20],[-20,20],[20,20],[-22,70],[22,70],[-24,120],[24,120]];return yt.map((r,n)=>({name:r,x:s+(i[n]?.[0]??0),y:240+(i[n]?.[1]??0),z:0,confidence:.4}))}var vs=Object.defineProperty,ms=Object.getOwnPropertyDescriptor,it=(e,t,a,s)=>{for(var i=s>1?void 0:s?ms(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&vs(t,a,i),i};const gs="https://cdn.jsdelivr.net/npm/@mediapipe/tasks-vision@0.10.14/wasm",bs="https://storage.googleapis.com/mediapipe-models/pose_landmarker/pose_landmarker_lite/float16/latest/pose_landmarker_lite.task";async function fs(){if(window.__mpPoseLandmarker)return window.__mpPoseLandmarker;if(window.__mpPoseLoading)return null;window.__mpPoseLoading=!0;try{const e=await is(()=>import("https://cdn.jsdelivr.net/npm/@mediapipe/tasks-vision@0.10.14/vision_bundle.mjs"),[]),{FilesetResolver:t,PoseLandmarker:a}=e,s=await t.forVisionTasks(gs),i=await a.createFromOptions(s,{baseOptions:{modelAssetPath:bs,delegate:"GPU"},runningMode:"VIDEO",numPoses:3});return window.__mpPoseLandmarker=i,i}catch(e){return console.error("[nv-camera-fusion] MediaPipe load failed:",e),null}finally{window.__mpPoseLoading=!1}}let be=class extends k{constructor(){super(...arguments),this._camError="",this._showPreview=!1,this._mpReady=!1,this._stream=null,this._rafId=0,this._landmarker=null,this._lastTs=0}async connectedCallback(){super.connectedCallback(),await this._startCamera()}disconnectedCallback(){super.disconnectedCallback(),this._stopCamera()}async _startCamera(){try{this._stream=await navigator.mediaDevices.getUserMedia({video:{width:640,height:480,facingMode:"user"},audio:!1}),K.value=!0,this._camError="",c("ok","🎥 Camera started — loading MediaPipe…"),await this.updateComplete;const e=this.renderRoot.querySelector("video");e&&(e.srcObject=this._stream,await e.play()),this._landmarker=await fs(),this._landmarker?(this._mpReady=!0,c("ok","🤖 MediaPipe Pose ready — hybrid fusion active"),this._startDetectionLoop()):(c("warn","⚠️ MediaPipe unavailable — WiFi-only mode"),q.value=0)}catch(e){this._camError=e instanceof Error?e.message:"Camera access denied",K.value=!1,q.value=0,c("warn",`📷 Camera unavailable: ${this._camError} — using WiFi mode`)}}_stopCamera(){cancelAnimationFrame(this._rafId),this._stream?.getTracks().forEach(e=>e.stop()),this._stream=null,this._landmarker?.close(),this._landmarker=null,K.value=!1,q.value=0,pt.value=[]}_startDetectionLoop(){const e=this.renderRoot.querySelector("video");if(!e||!this._landmarker)return;const t=()=>{if(!this._landmarker||e.readyState<2){this._rafId=requestAnimationFrame(t);return}const a=performance.now();if(a-this._lastTs<50){this._rafId=requestAnimationFrame(t);return}this._lastTs=a;try{const s=this._landmarker.detectForVideo(e,a);this._processResult(s)}catch{}this._rafId=requestAnimationFrame(t)};this._rafId=requestAnimationFrame(t)}_processResult(e){const t=e.landmarks??[];let a=0,s=0;const i=t.slice(0,3).map((r,n)=>{const o=r.slice(0,17).map((l,u)=>{const h=l.visibility??0;return a+=h,s++,{name:yt[u]??`kp_${u}`,x:(1-l.x)*640,y:l.y*480,z:l.z,confidence:h}});return{id:n+1,source:"camera",confidence:o.reduce((l,u)=>l+u.confidence,0)/o.length,keypoints:o}});pt.value=i,q.value=s>0?Math.min(a/s,1):0}togglePreview(){this._showPreview=!this._showPreview}render(){return d`
      <video
        style="display: none"
        playsinline
        muted
      ...
      ${this._showPreview?d`
        <div class="preview-wrap">
          <video playsinline muted autoplay
            ...
            @loadedmetadata=${e=>{const t=e.target;this._stream&&(t.srcObject=this._stream)}}
          ></video>
      ...
      ${this._camError?d`<div class="error">⚠ ${this._camError}</div>`:""}
    `}};be.styles=w`
    :host { display: block; }
    .preview-wrap {
      position: relative;
  ...
  `;it([v()],be.prototype,"_camError",2);it([v()],be.prototype,"_showPreview",2);it([v()],be.prototype,"_mpReady",2);be=it([$("nv-camera-fusion")],be);var ys=Object.defineProperty,xs=Object.getOwnPropertyDescriptor,rt=(e,t,a,s)=>{for(var i=s>1?void 0:s?xs(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ys(t,a,i),i};const Ce={camera:"oklch(0.78 0.18 145)",wifi:"oklch(0.78 0.14 195)",blend:"oklch(0.78 0.16 70)"};let fe=class extends k{constructor(){super(...arguments),this.viewW=640,this.viewH=480,this._tick=0}connectedCallback(){super.connectedCallback(),f(()=>{ut.value,Ie.value,K.value,q.value,De.value,this._tick++,this.requestUpdate()})}_sx(e){return e/this.viewW*1e3}_sy(e){return e/this.viewH*600}_renderPerson(e,t){const a=Ce[e.source]??Ce.wifi,s=e.keypoints;if(!s.length)return"";const i=s[0]??s[5],r=this._sx(i.x),n=this._sy(i.y),o=`P${e.id}`,l=e.source==="camera"?"🎥":e.source==="wifi"?"📡":"🔀",u=Math.round(e.confidence*100);return H`
      <g class="person-group" data-person-id=${e.id}>

        <!-- Bone connections -->
        ${ns.map(([h,b])=>{const y=s[h],A=s[b];if(!y||!A)return"";const D=Math.min(y.confidence,A.confidence);return D<.15?"":H`
            <line class="bone-line"
              x1=${this._sx(y.x)} y1=${this._sy(y.y)}
              x2=${this._sx(A.x)} y2=${this._sy(A.y)}
              stroke=${a}
              stroke-width=${1.5+D}
              stroke-opacity=${.4+D*.5}
              stroke-linecap="round"
            />
          `})}

        <!-- Keypoint circles -->
        ${s.map((h,b)=>{if(h.confidence<.15)return"";const y=b<5?4:3;return H`
            <circle class="kp-circle"
              cx=${this._sx(h.x)} cy=${this._sy(h.y)}
              r=${y}
              fill=${a}
              fill-opacity=${.6+h.confidence*.4}
    ...
    `}render(){const e=ut.value,t=Ie.value,a=K.value,s=q.value,i=De.value,r=t==="camera"?Ce.camera:t==="blend"?Ce.blend:Ce.wifi,n=t==="camera"?"🎥 Camera":t==="blend"?"🔀 Blend":"📡 WiFi";return d`
      <svg viewBox="0 0 1000 600" preserveAspectRatio="xMidYMid meet" id="pose-overlay-svg">
        ...
        ${e.map((o,l)=>this._renderPerson(o,l))}
      </svg>

      <!-- Status bar -->
      <div class="status-bar" id="fusion-status-bar">
        <span class="dot" style="background:${r}; box-shadow: 0 0 6px ${r};"></span>
        <span style="color:${r}; font-weight:600;">${n}</span>
        <span style="color:var(--ink-3);">·</span>
        <span>${e.length} person${e.length!==1?"s":""}</span>
        ${a?d`
          <span style="color:var(--ink-3);">·</span>
          <span>cam ${Math.round(s*100)}%</span>
        `:""}
        ${i>0?d`
          <span style="color:var(--ink-3);">·</span>
          <span>wifi ${i}</span>
  ...
  `;rt([ye({type:Number})],fe.prototype,"viewW",2);rt([ye({type:Number})],fe.prototype,"viewH",2);rt([v()],fe.prototype,"_tick",2);fe=rt([$("nv-pose-overlay")],fe);var ws=Object.defineProperty,ks=Object.getOwnPropertyDescriptor,xt=(e,t,a,s)=>{for(var i=s>1?void 0:s?ks(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ws(t,a,i),i};let He=class extends k{constructor(){super(...arguments),this.view="home",this._showCamera=!0}connectedCallback(){super.connectedCallback(),ps(),window.addEventListener("nv-toggle-camera",()=>{this._showCamera=!this._showCamera})}render(){const e=this.view==="home";return d`
      ...
      <div class="app ${e?"simple":""}">
        ...
        <main class="main" id="main-content" tabindex="-1" role="main" aria-label="Main view">
          ${this._showCamera?d`<nv-camera-fusion></nv-camera-fusion>`:""}
          ${this.view==="home"?d`<nv-home></nv-home>`:this.view==="apps"?d`<nv-app-store></nv-app-store>`:this.view==="ghost-murmur"?d`<nv-ghost-murmur></nv-ghost-murmur>`:this.view==="inspector"?d`<nv-inspector expanded .pinTab=${"signal"}></nv-inspector>`:this.view==="witness"?d`<nv-inspector expanded .pinTab=${"witness"}></nv-inspector>`:d`<nv-scene></nv-scene><nv-pose-overlay></nv-pose-overlay>`}
        </main>
        <nv-inspector
  ...
  `;xt([v()],He.prototype,"view",2);xt([v()],He.prototype,"_showCamera",2);He=xt([$("nv-app")],He);function $s(e,t,a){const s=e.getUint32(t+0,!0),i=e.getUint16(t+4,!0),r=e.getUint16(t+6,!0),n=e.getUint16(t+8,!0),o=e.getBigUint64(t+12,!0),l=e.getFloat32(t+20,!0),u=e.getFloat32(t+24,!0),h=e.getFloat32(t+28,!0),b=e.getFloat32(t+32,!0),y=e.getFloat32(t+36,!0),A=e.getFloat32(t+40,!0),D=e.getFloat32(t+44,!0),ke=e.getFloat32(t+48,!0);return{magic:s,version:i,flags:r,sensorId:n,tUs:o,bPt:[l,u,h],sigmaPt:[b,y,A],noiseFloorPtSqrtHz:D,temperatureK:ke,raw:a.subarray(t,t+60)}}function Ut(e){const a=new DataView(e.buffer,e.byteOffset,e.byteLength),s=[];for(let i=0;i+60<=e.byteLength;i+=60)s.push($s(a,i,e));return s}class Ss{constructor(){this.nextId=1,this.pending=new Map,this.frameSubs=new Set,this.eventSubs=new Set,this.bootInfo=null,this.worker=new Worker(new URL("/WeView/nvsim/assets/worker-C19MRcXs.js",import.meta.url),{type:"module"}),this.worker.addEventListener("message",t=>this.onMessage(t)),this.worker.addEventListener("error",t=>this.eventSubs.forEach(a=>a({type:"log",level:"err",msg:String(t.message)})))}onMessage(t){const a=t.data;if(a.type==="frames"){const s=a.batch,i=new Uint8Array(s),n={frames:Ut(i),bytes:i};this.frameSubs.forEach(l=>l(n));const o=a.fps;o>0&&this.eventSubs.forEach(l=>l({type:"fps",value:o}));return}if(a.type==="state"){this.eventSubs.forEach(s=>s({type:"state",running:!!a.running,t:0,framesEmitted:Number(a.framesEmitted??0)}));return}if(a.type!=="ready"){if(a.type==="err"&&a.id==null){this.eventSubs.forEach(s=>s({type:"log",level:"err",msg:String(a.msg)}));return}if(typeof a.id=="number"&&this.pending.has(a.id)){const s=this.pending.get(a.id);this.pending.delete(a.id),a.type==="err"?s.reject(new Error(String(a.msg))):s.resolve(a)}}}rpc(t,a=[]){const s=this.nextId++;return new Promise((i,r)=>{this.pending.set(s,{resolve:i,reject:r}),this.worker.postMessage({...t,id:s},a)})}async boot(){if(this.bootInfo)return this.bootInfo;const a=await this.rpc({type:"boot",base:"/WeView/nvsim/"});return this.bootInfo={buildVersion:a.buildVersion,frameMagic:a.frameMagic,frameBytes:a.frameBytes,expectedWitnessHex:a.expectedWitnessHex},this.bootInfo}async loadScene(t){await this.rpc({type:"setScene",json:JSON.stringify(t)})}async setConfig(t){await this.rpc({type:"setConfig",json:JSON.stringify(t)})}async setSeed(t){await this.rpc({type:"setSeed",seed:Number(t&0xFFFFFFFFn)})}async reset(){await this.rpc({type:"reset"})}async run(t){await this.rpc({type:"run"})}async pause(){await this.rpc({type:"pause"})}async step(t,a){await this.rpc({type:"step"})}onFrames(t){this.frameSubs.add(t)}onEvent(t){this.eventSubs.add(t)}async generateWitness(t){const a=await this.rpc({type:"witnessGenerate",samples:t});return new Uint8Array(a.witness)}async verifyWitness(t){const a=t.slice().buffer,s=await this.rpc({type:"witnessVerify",samples:256,expected:a},[a]);return s.ok?{ok:!0}:{ok:!1,actual:new Uint8Array(s.actual)}}async runTransient(t,a,s,i){const r=await this.rpc({type:"runTransient",scene:JSON.stringify(t),config:JSON.stringify(a),seed:Number(s&0xFFFFFFFFn),samples:i});return{bRecoveredT:[r.bRecoveredT[0],r.bRecoveredT[1],r.bRecoveredT[2]],bMagT:r.bMagT,noiseFloorPtSqrtHz:r.noiseFloorPtSqrtHz,sigmaPt:[r.sigmaPt[0],r.sigmaPt[1],r.sigmaPt[2]],nFrames:r.nFrames,witnessHex:r.witnessHex}}async exportProofBundle(){const t=await this.generateWitness(256),a=Array.from(t).map(r=>r.toString(16).padStart(2,"0")).join(""),s=this.bootInfo??await this.boot(),i=JSON.stringify({kind:"nvsim-proof-bundle",version:s.buildVersion,seed:"0x0000002A",nSamples:256,witness:a,expected:s.expectedWitnessHex,ok:a===s.expectedWitnessHex,ts:new Date().toISOString()},null,2);return new Blob([i],{type:"application/json"})}async buildId(){return(await this.rpc({type:"buildId"})).buildId}async close(){this.worker.terminate()}}function _s(e){return e.startsWith("ws://")||e.startsWith("wss://")?e:e.replace(/^http/,"ws")}class Ts{constructor(t){this.ws=null,this.bootInfo=null,this.frameSubs=new Set,this.eventSubs=new Set,this.running=!1,this.framesEmitted=0,this.fpsLast=performance.now(),this.fpsCount=0,this.baseUrl=t.replace(/\/$/,""),this.baseUrl.endsWith("/ws/sensing")?(this.wsUrl=this.baseUrl,this.baseUrl=this.baseUrl.replace("ws://","http://").replace("/ws/sensing","")):this.wsUrl=`${_s(this.baseUrl)}/ws/stream`}async json(t,a){const s=await fetch(`${this.baseUrl}${t}`,{...a,headers:{"content-type":"application/json",...a?.headers??{}}});if(!s.ok)throw new Error(`${t}: ${s.status} ${s.statusText}`);return await s.json()}async boot(){if(this.bootInfo)return this.bootInfo;try{const t=await this.json("/api/health");this.bootInfo={buildVersion:t.nvsim_version,frameMagic:t.magic,frameBytes:t.frame_bytes,expectedWitnessHex:t.expected_witness_hex}}catch{this.bootInfo={buildVersion:"sensing-server",frameMagic:0,frameBytes:0,expectedWitnessHex:"0000"}}return this.openWs(),this.bootInfo}openWs(){if(this.ws)return;const t=new WebSocket(this.wsUrl);t.binaryType="arraybuffer",t.onopen=()=>{this.eventSubs.forEach(a=>a({type:"log",level:"ok",msg:`ws/stream connected · ${this.wsUrl}`}))},t.onclose=()=>{this.ws=null,this.eventSubs.forEach(a=>a({type:"log",level:"warn",msg:"ws/stream closed"}))},t.onerror=()=>{this.eventSubs.forEach(a=>a({type:"log",level:"err",msg:`ws/stream error · ${this.wsUrl}`}))},t.onmessage=a=>{if(typeof a.data=="string"){try{const o=JSON.parse(a.data);o.type==="sensing_update"&&this.eventSubs.forEach(l=>l({type:"sensing_update",data:o}))}catch{}return}if(!(a.data instanceof ArrayBuffer))return;const s=new Uint8Array(a.data),i=Ut(s);if(i.length===0)return;const r={frames:i,bytes:s};this.frameSubs.forEach(o=>o(r)),this.framesEmitted+=i.length,this.fpsCount+=i.length;const n=performance.now();if(n-this.fpsLast>=1e3){const o=this.fpsCount*1e3/(n-this.fpsLast);this.eventSubs.forEach(l=>l({type:"fps",value:o})),this.fpsLast=n,this.fpsCount=0}},this.ws=t}async loadScene(t){this.bootInfo?.buildVersion!=="sensing-server"&&await this.json("/api/scene",{method:"PUT",body:JSON.stringify(t)})}async setConfig(t){this.bootInfo?.buildVersion!=="sensing-server"&&await this.json("/api/config",{method:"PUT",body:JSON.stringify(t)})}async setSeed(t){this.bootInfo?.buildVersion!=="sensing-server"&&await this.json("/api/seed",{method:"PUT",body:JSON.stringify({seed_hex:"0x"+t.toString(16).toUpperCase().padStart(16,"0")})})}async reset(){this.bootInfo?.buildVersion!=="sensing-server"&&await this.json("/api/reset",{method:"POST"}),this.running=!1,this.framesEmitted=0,this.eventSubs.forEach(t=>t({type:"state",running:!1,t:0,framesEmitted:0}))}async run(t){this.bootInfo?.buildVersion!=="sensing-server"&&await this.json("/api/run",{method:"POST"}),this.running=!0,this.eventSubs.forEach(a=>a({type:"state",running:!0,t:0,framesEmitted:this.framesEmitted}))}async pause(){this.bootInfo?.buildVersion!=="sensing-server"&&await this.json("/api/pause",{method:"POST"}),this.running=!1,this.eventSubs.forEach(t=>t({type:"state",running:!1,t:0,framesEmitted:this.framesEmitted}))}async step(t,a){await this.json("/api/step",{method:"POST",body:JSON.stringify({direction:t,dt_ms:a})})}onFrames(t){this.frameSubs.add(t)}onEvent(t){this.eventSubs.add(t)}async generateWitness(t){const a=await this.json("/api/witness/generate",{method:"POST",body:JSON.stringify({samples:t})}),s=new Uint8Array(32);for(let i=0;i<32;i++)s[i]=parseInt(a.witness_hex.slice(i*2,i*2+2),16);return s}async verifyWitness(t){const a=Array.from(t).map(r=>r.toString(16).padStart(2,"0")).join(""),s=await this.json("/api/witness/verify",{method:"POST",body:JSON.stringify({expected_hex:a,samples:256})});if(s.ok)return{ok:!0};const i=new Uint8Array(32);for(let r=0;r<32;r++)i[r]=parseInt(s.actual_hex.slice(r*2,r*2+2),16);return{ok:!1,actual:i}}async exportProofBundle(){const t=await fetch(`${this.baseUrl}/api/export-proof`,{method:"POST"}).then(a=>a.text());return new Blob([t],{type:"application/json"})}async runTransient(t,a,s,i){return{bRecoveredT:[0,0,0],bMagT:0,noiseFloorPtSqrtHz:0,sigmaPt:[0,0,0],nFrames:0,witnessHex:"(transient route not available in WS transport — V1 limitation)"}}async buildId(){return`nvsim@${(this.bootInfo??await this.boot()).buildVersion} (ws)`}async close(){this.ws?.close(),this.ws=null}}function Pt(e){document.documentElement.setAttribute("data-theme",e)}function Et(e){document.body.classList.remove("density-comfy","density-default","density-compact"),document.body.classList.add(`density-${e}`)}function Rt(e){document.body.classList.toggle("reduce-motion",e)}(async()=>{const e=await W("theme")??"dark",t=await W("density")??"default",a=window.matchMedia?.("(prefers-reduced-motion: reduce)").matches??!1,s=await W("motionReduced")??a;T.value=e,Pt(e),O.value=t,Et(t),N.value=s,Rt(s),f(()=>{Pt(T.value),B("theme",T.value)}),f(()=>{Et(O.value),B("density",O.value)}),f(()=>{Rt(N.value),B("motionReduced",N.value)});const i=await W("repl-history");i&&Array.isArray(i)&&(ae.value=i),f(()=>{B("repl-history",ae.value)});const r=await W("scene-positions");r&&Array.isArray(r)&&(ue.value=r),f(()=>{B("scene-positions",ue.value)});const n=await W("wsUrl")??"";n&&(R.value=n);const o=await W("transport")??"wasm";P.value=o,f(()=>{if(B("wsUrl",R.value),R.value){const x=R.value.replace(/^ws/,"http").replace(/\/ws\/stream$/,"");os(x)}}),f(()=>{B("transport",P.value)});const l={},u=[],h=performance.now(),b=x=>{if(x.frames.length===0)return;const m=x.frames[x.frames.length-1];te.value=m;const _=m.bPt[0]*1e-12,I=m.bPt[1]*1e-12,L=m.bPt[2]*1e-12;Re.value=[_,I,L];const z=Math.sqrt(_*_+I*I+L*L);for(se.value=z,da([_*1e9,I*1e9,L*1e9]),ca(Math.min(1,Math.abs(L*1e9)/5+.3)),u.push(z);u.length>256;)u.shift();const Be=Ot.value;if(Be.size===0)return;const jt=(performance.now()-h)/1e3;for(const $e of Be){const kt=Wt[$e];if(!kt)continue;l[$e]||(l[$e]={});const Gt={frame:m,bMagT:z,bRecoveredT:[_,I,L],bHistory:u,elapsedS:jt,state:l[$e]};try{const ne=kt(Gt);if(!ne)continue;const Kt=Array.isArray(ne)?ne:[ne];for(const oe of Kt)na(oe),c("info",`<span class="k">[${oe.appId}]</span> <span class="s">${oe.eventName}</span> <span class="n">(${oe.eventId})</span>${oe.detail?" · "+oe.detail:""}`)}catch(ne){c("warn",`[${$e}] runtime error: ${ne.message}`)}}};let y=null;async function A(){try{y&&await y.close();const x=P.value;if(x==="ws"&&R.value.trim()){const m=new Ts(R.value.trim()),_=await m.boot();y=m,Ve.value=!0,nt.value=null,V.value=_.expectedWitnessHex,D(m),c("ok",`transport WS · ${R.value} · nvsim@${_.buildVersion}`)}else{x==="ws"&&c("warn","WS transport selected but no URL set — falling back to WASM");const m=new Ss,_=await m.boot();y=m,Ve.value=!0,nt.value=null,V.value=_.expectedWitnessHex,D(m),c("ok",`transport WASM · nvsim@${_.buildVersion} · magic=0x${_.frameMagic.toString(16).toUpperCase()}`)}oa(y)}catch(x){const m=x.message;nt.value=m,Ve.value=!1,c("err",`transport boot failed: ${m}`)}}function D(x){x.onEvent(m=>{m.type==="log"&&c(m.level,m.msg),m.type==="fps"&&(M.value=m.value),m.type==="state"&&(ct.value=BigInt(m.framesEmitted)),m.type==="sensing_update"&&us(m.data)}),x.onFrames(b)}let ke=!1;f(()=>{P.value,R.value,!ke&&(ke=!0,A().finally(()=>{ke=!1}))}),c("info","nvsim — booting transport");let wt=null;f(()=>{const x=V.value,m=Ve.value;!x||!m||wt!==x&&(wt=x,(async()=>{const _=y;if(_)try{const I=new Uint8Array(32);for(let z=0;z<32;z++)I[z]=parseInt(x.slice(z*2,z*2+2),16);const L=await _.verifyWitness(I);if(L.ok)F.value=x,c("ok",`witness verified · determinism gate ✓ · transport=${P.value}`);else{const z=Array.from(L.actual).map(Be=>Be.toString(16).padStart(2,"0")).join("");F.value=z,c("err",`WITNESS MISMATCH · expected ${x.slice(0,16)}… got ${z.slice(0,16)}…`)}}catch(I){c("warn",`witness verify skipped: ${I.message}`)}})())}),ia.value="(reference scene)"})();
//# sourceMappingURL=index-C4rgjILh.js.map
