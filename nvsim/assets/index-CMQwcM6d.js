import{f as Yt,u as Xt,i as w,a as k,b as d,w as q}from"./lit-BS7WqYd5.js";import{y as p,g as Qt,j as f}from"./signals-SG45zFCj.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function a(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=a(i);fetch(i.href,r)}})();/**
 * @license
 ...
 */function Dt(e,t){return(a,s,i)=>{const r=n=>n.renderRoot?.querySelector(e)??null;return ea(a,s,{get(){return r(this)}})}}var ta=Object.defineProperty,aa=Object.getOwnPropertyDescriptor,It=(e,t,a,s)=>{for(var i=s>1?void 0:s?aa(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ta(t,a,i),i};let Ge=class extends k{constructor(){super(...arguments),this.view="scene"}navigate(e){this.dispatchEvent(new CustomEvent("navigate",{detail:e}))}render(){return d`
  ...
  `;vt=fa([$("nv-sidebar")],vt);var ya=Object.defineProperty,xa=Object.getOwnPropertyDescriptor,xe=(e,t,a,s)=>{for(var i=s>1?void 0:s?xa(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ya(t,a,i),i};let Y=class extends k{constructor(){super(...arguments),this.zoom=1,this.layerVisible={source:!0,field:!0,label:!0},this.items=[{id:"rebar",x:740,y:240,color:"oklch(0.72 0.18 330)",name:"rebar.steel"},{id:"heart",x:220,y:180,color:"oklch(0.78 0.14 195)",name:"heart_proxy"},{id:"mains",x:180,y:380,color:"oklch(0.72 0.18 330)",name:"mains_60Hz"},{id:"door",x:800,y:470,color:"oklch(0.78 0.14 145)",name:"door.steel"}],this.dragging=null,this.selected=null,this.dragOffset={dx:0,dy:0},this.onKey=e=>{const t=e.target;if(!(t&&(t.tagName==="INPUT"||t.tagName==="TEXTAREA"))){if(!this.selected){e.key==="Tab"&&document.activeElement===document.body&&(e.preventDefault(),this.selected=this.items[0]?.id??null);return}if(e.key==="ArrowLeft"||e.key==="ArrowRight"||e.key==="ArrowUp"||e.key==="ArrowDown"){e.preventDefault();const a=e.shiftKey?32:8,s=e.key==="ArrowLeft"?-a:e.key==="ArrowRight"?a:0,i=e.key==="ArrowUp"?-a:e.key==="ArrowDown"?a:0;this.items=this.items.map(r=>r.id===this.selected?{...r,x:Math.max(20,Math.min(980,r.x+s)),y:Math.max(20,Math.min(580,r.y+i))}:r),ue.value=this.items.map(({id:r,x:n,y:o})=>({id:r,x:n,y:o}))}else if(e.key==="Tab"){e.preventDefault();const s=(this.items.findIndex(i=>i.id===this.selected)+(e.shiftKey?-1:1)+this.items.length)%this.items.length;this.selected=this.items[s].id}else e.key==="Escape"&&(this.selected=null)}},this.onDown=(e,t)=>{t.preventDefault(),this.dragging=e,this.selected=e;const a=this.items.find(r=>r.id===e);if(!a)return;const s=this.renderRoot.querySelector("svg");if(!s)return;const i=this.toSvg(t,s);this.dragOffset={dx:i.x-a.x,dy:i.y-a.y}},this.onPointerMove=e=>{if(!this.dragging)return;const t=this.renderRoot.querySelector("svg");if(!t)return;const a=this.toSvg(e,t);this.items=this.items.map(s=>s.id===this.dragging?{...s,x:a.x-this.dragOffset.dx,y:a.y-this.dragOffset.dy}:s)},this.onPointerUp=()=>{this.dragging&&(ue.value=this.items.map(({id:e,x:t,y:a})=>({id:e,x:t,y:a}))),this.dragging=null}}connectedCallback(){super.connectedCallback(),ue.value.length>0&&(this.items=this.items.map(e=>{const t=ue.value.find(a=>a.id===e.id);return t?{...e,x:t.x,y:t.y}:e})),f(()=>{Re.value,se.value,M.value,ee.value,N.value,g.value,qe.value,te.value,this.requestUpdate()}),f(()=>{const e=te.value;if(!e)return;const t=Math.sqrt(e.bPt[0]**2+e.bPt[1]**2+e.bPt[2]**2),a=Math.max(Math.abs(e.sigmaPt[0]),Math.abs(e.sigmaPt[1]),Math.abs(e.sigmaPt[2]),.001),s=t/a;Number.isFinite(s)&&(ee.value=s)}),window.addEventListener("pointermove",this.onPointerMove),window.addEventListener("pointerup",this.onPointerUp),window.addEventListener("keydown",this.onKey)}async toggleRun(){const e=S();e&&(g.value?(await e.pause(),g.value=!1):(await e.run(),g.value=!0))}async stepFwd(){const e=S();e&&(await e.step("fwd",10),c("dbg","sim step → +1 frame"))}async stepBack(){const e=S();e&&(await e.step("back",10),c("dbg","sim step ← -1 frame"))}cycleSpeed(){const e=[.25,.5,1,2,4],t=e.indexOf(qe.value);qe.value=e[(t+1)%e.length]}zoomIn(){this.zoom=Math.min(2.5,this.zoom*1.2)}zoomOut(){this.zoom=Math.max(.5,this.zoom/1.2)}fitView(){this.zoom=1}toggleLayer(e){this.layerVisible={...this.layerVisible,[e]:!this.layerVisible[e]}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("pointermove",this.onPointerMove),window.removeEventListener("pointerup",this.onPointerUp),window.removeEventListener("keydown",this.onKey)}toSvg(e,t){const a=t.getBoundingClientRect(),s=(e.clientX-a.left)/a.width*1e3,i=(e.clientY-a.top)/a.height*600;return{x:s,y:i}}render(){const e=Re.value,t=[e[0]*1e9,e[1]*1e9,e[2]*1e9],a=se.value*1e9,s=N.value?"":"anim",i=1e3/this.zoom,r=600/this.zoom,n=(1e3-i)/2,o=(600-r)/2;return d`
      ...
      <svg viewBox="${n.toFixed(1)} ${o.toFixed(1)} ${i.toFixed(1)} ${r.toFixed(1)}"
        ...
        ${this.layerVisible.field?this.items.map(l=>q`
        ...
        <!-- Source primitives -->
        ${this.layerVisible.source?this.items.map(l=>q`
          <g class=${`draggable ${this.dragging===l.id?"dragging":""} ${this.selected===l.id?"selected":""}`}
            ...
            ${this.layerVisible.label?q`<text class="label" x="0" y="40" text-anchor="middle">${l.name}</text>`:""}
          </g>
        `):""}
  ...
  `;xe([v()],Y.prototype,"zoom",2);xe([v()],Y.prototype,"layerVisible",2);xe([v()],Y.prototype,"items",2);xe([v()],Y.prototype,"dragging",2);xe([v()],Y.prototype,"selected",2);Y=xe([$("nv-scene")],Y);var wa=Object.defineProperty,ka=Object.getOwnPropertyDescriptor,at=(e,t,a,s)=>{for(var i=s>1?void 0:s?ka(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&wa(t,a,i),i};let ve=class extends k{constructor(){super(...arguments),this.tab="signal",this.pinTab=null,this.expanded=!1}connectedCallback(){super.connectedCallback(),f(()=>{Pe.value,Ke.value,Ye.value,Ee.value,te.value,F.value,C.value,Re.value,se.value,this.requestUpdate()})}willUpdate(e){e.has("pinTab")&&this.pinTab&&this.tab!==this.pinTab&&(this.tab=this.pinTab)}async verify(){const e=S();if(e){C.value="pending",c("info","verifying witness over 256 frames…");try{const t=B.value,a=new Uint8Array(32);for(let i=0;i<32;i++)a[i]=parseInt(t.slice(i*2,i*2+2),16);const s=await e.verifyWitness(a);if(s.ok)C.value="ok",F.value=t,c("ok",`witness ${t.slice(0,16)}… matches · determinism gate ✓`);else{C.value="fail";const i=Array.from(s.actual).map(r=>r.toString(16).padStart(2,"0")).join("");F.value=i,c("err",`WITNESS MISMATCH actual=${i.slice(0,16)}…`)}}catch(t){C.value="fail",c("err",`verify failed: ${t.message}`)}}}renderHeader(){return this.expanded?d`
    ...
    `:""}renderSignalTab(){const r=u=>{let h="";return u.forEach((b,y)=>{const z=y/Math.max(1,199)*320,D=65-b*22;h+=(y===0?"M":"L")+` ${z.toFixed(1)} ${D.toFixed(1)} `}),h},n=Re.value,o=[n[0]*1e9,n[1]*1e9,n[2]*1e9],l=Pe.value.length>0;return d`
      ${l?"":d`
      ...
      <div class=${this.expanded?"grid-2":""}>
        <div class="card">
          ...
          <svg viewBox="0 0 ${320} ${130}" preserveAspectRatio="none">
            ...
            ${q`<path id="trace-x" d=${r(Pe.value)} stroke="oklch(0.78 0.14 70)" stroke-width="1.2" fill="none"/>`}
            ${q`<path id="trace-y" d=${r(Ke.value)} stroke="oklch(0.78 0.12 195)" stroke-width="1.2" fill="none" opacity="0.8"/>`}
            ${q`<path id="trace-z" d=${r(Ye.value)} stroke="oklch(0.72 0.18 330)" stroke-width="1.2" fill="none" opacity="0.7"/>`}
          </svg>
    ...
    `}renderWitnessTab(){const e=C.value,t=e==="ok"?"ok":e==="fail"?"fail":"",a=e==="pending"?"Verifying…":e==="ok"?"✓ Witness verified · determinism gate":e==="fail"?"✗ Witness mismatch · audit required":"Verify witness",s=B.value&&F.value&&B.value===F.value;return d`
      ${this.expanded?d`
      ...
      <div class="card">
        ...
        <div class="witness-box" id="expected-witness">${B.value||"(loading…)"}</div>
      </div>
      <div class="card">
        <div class="card-h">
  ...
  `;Bt([v()],Ze.prototype,"renderTick",2);Ze=Bt([$("nv-app-store")],Ze);var Na=Object.defineProperty,Ha=Object.getOwnPropertyDescriptor,We=(e,t,a,s)=>{for(var i=s>1?void 0:s?Ha(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&Na(t,a,i),i};let re=class extends k{constructor(){super(...arguments),this.open=!1,this.filter="",this.idx=0,this.cmds=[{ico:"▶",label:"Run pipeline",kbd:"Space",run:async()=>{await S()?.run(),g.value=!0,U("Pipeline running","▶")}},{ico:"❚",label:"Pause pipeline",run:async()=>{await S()?.pause(),g.value=!1,U("Paused","❚❚")}},{ico:"+",label:"New scene…",kbd:"⌘N",run:()=>ze({title:"New scene",body:`<p>Build a fresh magnetic scene. The dashboard generates the JSON
      ...
      </div>`,buttons:[{label:"Close",variant:"primary"}]})},{ico:"i",label:"About nvsim…",run:()=>ze({title:"About nvsim",body:`<p><b>nvsim</b> is a deterministic, byte-reproducible forward simulator for nitrogen-vacancy diamond magnetometry.</p>
  ...
  `;it([v()],be.prototype,"_camError",2);it([v()],be.prototype,"_showPreview",2);it([v()],be.prototype,"_mpReady",2);be=it([$("nv-camera-fusion")],be);var ys=Object.defineProperty,xs=Object.getOwnPropertyDescriptor,rt=(e,t,a,s)=>{for(var i=s>1?void 0:s?xs(t,a):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=(s?n(t,a,i):n(i))||i);return s&&i&&ys(t,a,i),i};const Ce={camera:"oklch(0.78 0.18 145)",wifi:"oklch(0.78 0.14 195)",blend:"oklch(0.78 0.16 70)"};let fe=class extends k{constructor(){super(...arguments),this.viewW=640,this.viewH=480,this._tick=0}connectedCallback(){super.connectedCallback(),f(()=>{ut.value,Ie.value,K.value,V.value,De.value,this._tick++,this.requestUpdate()})}_sx(e){return e/this.viewW*1e3}_sy(e){return e/this.viewH*600}_renderPerson(e,t){const a=Ce[e.source]??Ce.wifi,s=e.keypoints;if(!s.length)return"";const i=s[0]??s[5],r=this._sx(i.x),n=this._sy(i.y),o=`P${e.id}`,l=e.source==="camera"?"🎥":e.source==="wifi"?"📡":"🔀",u=Math.round(e.confidence*100);return q`
      <g class="person-group" data-person-id=${e.id}>
        ...
        <!-- Keypoint circles -->
        ${s.map((h,b)=>{if(h.confidence<.15)return"";const y=b<5?4:3;return q`
    ...
    `}render(){const e=ut.value,t=Ie.value,a=K.value,s=V.value,i=De.value,r=t==="camera"?Ce.camera:t==="blend"?Ce.blend:Ce.wifi,n=t==="camera"?"🎥 Camera":t==="blend"?"🔀 Blend":"📡 WiFi";return d`
